...
$string['action_createcertificate_issuemultiplecertificates'] = 'Issue multiple certificates';
$string['action_createcertificate_issuemultiplecertificates_allow'] = 'Issues a certificate whenever condition is met.(override global)';
$string['action_createcertificate_issuemultiplecertificates_prevent'] = 'Issue only one certificate when condition is met.(override global)';
$string['action_createcertificate_issuemultiplecertificates_useglobal'] = 'Use global setting';
...
$string['addtocalendarlockedhint'] = 'The field "Add to Moodle calendar" is locked for all booking options (plugin setting: Lock "Add to Moodle calendar"). As an administrator you can {$a}.';
$string['addtocalendarlockedhint_link'] = 'unlock it in the plugin settings';
...
$string['agent_booking_configure_use_list_instance_settings'] = 'This skill only updates booking instance settings. To list the configurable fields and their current values, use the read-only skill mod_booking.list_instance_settings.';
...
$string['agent_booking_details_error_option_out_of_scope'] = 'This booking option does not belong to the booking activity you are working in, so its details are not available here.';
...
$string['agent_booking_diagnose_cancel_reason_concrete_enrollink_used'] = 'Concrete state: another user is booked via the enrolment link of this booking answer (booking_enrollink_items with consumed = 1 belonging to the bundle of the answer). Self-cancellation is blocked on purpose; a cashier or a user with booking management rights has to cancel the booking for the user if needed (users booked via the link stay booked, the link becomes invalid).';
...
$string['agent_booking_diagnose_cancel_reason_enrollink_used'] = 'You booked places for other users and somebody already booked via your enrolment link, so you cannot cancel this booking anymore.';
$string['agent_booking_diagnose_cancel_reason_enrollink_used_other'] = 'The selected user booked places for other users and somebody already booked via their enrolment link, so the user cannot cancel this booking anymore.';
...
$string['agent_booking_diagnose_error_user_not_found'] = 'No user matched "{$a}". Please give their exact name, e-mail or user id.';
$string['agent_booking_diagnose_error_user_resolution_failed'] = 'The user could not be resolved from "{$a}". Please give their exact name, e-mail or user id.';
...
$string['agent_booking_diagnose_user_optionquery_unresolved'] = 'I could not match "{$a}" to exactly one booking option, so this is the overview of all bookings instead. Give the exact option title or the option id to focus the diagnosis.';
...
$string['agent_booking_option_target_ambiguous'] = 'The option "{$a}" exists in several booking activities. Please tell me which activity it should apply to (or use the option id). Candidates:';
...
$string['agent_booking_resolve_user_reference_unresolved'] = 'The user reference could not be carried over from the conversation. Please name the person again by name or e-mail address.';
$string['agent_booking_rules_created_rule_load_failed'] = 'Rule was created but could not be loaded.';
$string['agent_booking_rules_multiple_rules_match'] = 'Multiple rules match. Please provide a ruleid.';
$string['agent_booking_rules_multiple_templates_match'] = 'Multiple templates match. Please be more specific or provide a templateid.';
$string['agent_booking_rules_no_matching_rule'] = 'No matching rule found.';
$string['agent_booking_rules_no_rules_in_context'] = 'No booking rules found in the current context.';
$string['agent_booking_rules_no_templates_available'] = 'No rule templates available.';
$string['agent_booking_rules_only_current_context_editable'] = 'Only rules of the current booking context may be edited.';
$string['agent_booking_rules_only_predefined_templates_allowed'] = 'Only predefined templates (negative IDs) are allowed.';
$string['agent_booking_rules_only_predefined_templates_supported'] = 'Only predefined templates (negative IDs) are supported.';
$string['agent_booking_rules_provide_ruleid_or_query'] = 'Please provide ruleid or rulequery.';
$string['agent_booking_rules_provide_templateid_or_query'] = 'Please provide a template ID or a template search term.';
$string['agent_booking_rules_rule_data_prepare_failed'] = 'Rule data could not be prepared.';
$string['agent_booking_rules_rule_not_found'] = 'Rule was not found.';
$string['agent_booking_rules_ruleid_not_found_in_context'] = 'Rule ID was not found in the current context.';
$string['agent_booking_rules_saved_rule_not_determined'] = 'Rule was saved but could not be uniquely determined.';
$string['agent_booking_rules_template_data_prepare_failed'] = 'Template data could not be prepared.';
$string['agent_booking_rules_template_load_failed'] = 'Template could not be loaded.';
$string['agent_booking_rules_templateid_not_found'] = 'Template ID was not found.';
$string['agent_booking_rules_updated_rule_load_failed'] = 'Rule was updated but could not be loaded.';
$string['agent_booking_search_options_query_must_be_string'] = 'The search query must be a text value.';
...
$string['agent_booking_unknown_task'] = 'Unknown task "{$a}".';
...
$string['agent_booking_update_option_missing_preview_context'] = 'The previous preview context is no longer available.';
$string['agent_booking_update_option_missing_preview_question'] = 'Please specify again which booking option should be updated (option title or option id).';
$string['agent_booking_update_option_missing_target'] = 'Please specify which booking option should be updated.';
$string['agent_booking_update_option_resolution_ambiguous_question'] = 'Several booking options match. Which one should I update? Please provide the exact title or option id.';
...
$string['agent_booking_waitinglist_nothing_blocking'] = 'Nothing is blocking the waiting list: the option has a waiting list, no global switch is off and no per-option gate applies. If a reduction still moved nobody, re-check the exact seat and waiting list numbers.';
$string['agent_booking_waitinglist_reason_aftercoursestart'] = 'The site setting "Turn off automatic moving up from waiting list after a booking option has started" is on and this option has already started, so nobody is moved up anymore.';
$string['agent_booking_waitinglist_reason_keepusersbooked'] = 'The site setting "Keep users booked on limit reduction" (keepusersbookedonreducingmaxanswers) is on - so reducing the number of seats keeps everybody booked and the option simply stays overbooked. Note: this setting is ON by default.';
$string['agent_booking_waitinglist_reason_missingdeleteresponses'] = 'You are saving without the capability mod/booking:deleteresponses, which is required for a limit reduction to demote or remove anybody. Without it the reduction silently changes nothing.';
$string['agent_booking_waitinglist_reason_nowaitinglist'] = 'This option has no waiting list (limit answers is off or the maximum number of participants is 0), so there is nobody to move.';
$string['agent_booking_waitinglist_reason_optionstarted'] = 'The option has already started and the booking instance does not allow booking after the course start ("Allow booking after start"). This stops the whole waiting list sync, including any demotion when you reduce the seats.';
$string['agent_booking_waitinglist_reason_paidoption'] = 'This is a paid option. Users who bought a seat are never moved automatically - they are neither promoted onto a paid option nor demoted or removed when you reduce the seats.';
$string['agent_booking_waitinglist_reason_turnoffglobal'] = 'The site setting "Turn off waiting list globally" (turnoffwaitinglist) is on, so the waiting list does not sync at all.';
$string['agent_booking_waitinglist_reason_waitforconfirmation'] = 'This option uses demand confirmation (waitforconfirmation), so it is never reduced automatically and users need manual confirmation before they move up.';
...
$string['bocondcancelmyselfenrollinkused'] = 'You cannot cancel anymore because your enrolment link has already been used.';
...
$string['bocondslotbooking'] = 'Select a slot';
$string['bocondslotmove'] = 'Move your booked slot';
...
$string['bojwtalg'] = "JWT signing algorithm";
$string['bojwtalg_desc'] = "HS256 signs with a shared secret (put the secret in the signing key field). RS256 signs with an RSA private key (put the PEM private key in the signing key field); the receiver verifies with the matching public key, so no secret has to be shared.";
$string['bojwtaudience'] = "JWT audience (aud)";
$string['bojwtaudience_desc'] = "Optional. Identifier of the intended receiver, added as the standard \"aud\" claim so the receiver can reject tokens meant for someone else.";
$string['bojwtenable'] = "Sign the request with a JWT";
$string['bojwtenable_desc'] = "Optional. Adds a signed JSON Web Token (RFC 7519) proving the request came from this site and was not tampered with. Any JWT-aware receiver can verify it. Recommended together with a JSON body (the token binds the exact body via a body_sha256 claim).";
$string['bojwtheader'] = "JWT header name";
$string['bojwtheader_desc'] = "Optional, default \"Authorization\" (sent as \"Bearer <token>\"). Set a different header name if the receiver expects the raw token elsewhere (e.g. \"X-Webhook-Token\").";
$string['bojwtkey'] = "JWT signing key";
$string['bojwtkey_desc'] = "The HS256 shared secret, or the RS256 PEM private key, used to sign the token. Stored with the action and never sent to the receiver.";
$string['bojwtkid'] = "JWT key id (kid)";
$string['bojwtkid_desc'] = "Optional. For RS256, the key id placed in the token header so a receiver with several public keys (a JWKS) can pick the right one.";
$string['bojwtttl'] = "JWT lifetime (seconds)";
$string['bojwtttl_desc'] = "Optional, default 300. How long the token stays valid (the \"exp\" claim). Keep it short to limit replay.";
...
$string['bookallstudents'] = 'Book all students';
$string['bookallstudentsqueued'] = 'Bulk booking task has been queued. This may take a minute or two to complete.';
$string['bookallstudentsresult'] = 'Bulk booking finished. Booked: {$a->booked}, waiting list: {$a->waitinglist}, skipped: {$a->skipped}, failed: {$a->failed}.';
$string['bookallstudentsstoppedforcapacity'] = 'Stopped because no more places/slots were available.';
...
$string['bookedslotsfromevent'] = 'Slots carried by the triggering event (supports slot booked/moved/cancelled events).';
...
$string['booking:bookallstudents'] = 'Book all enrolled students into an option';
...
$string['booking:changecustomformofotherusers'] = 'Edit the custom form values other users entered when booking (PRO)';
...
$string['booking:skill_mod_booking_analyze_rules'] = 'AI skill: analyse booking rules';
$string['booking:skill_mod_booking_book_users'] = 'AI skill: book users into an option';
$string['booking:skill_mod_booking_bulk_update_options'] = 'AI skill: bulk-update booking options';
$string['booking:skill_mod_booking_configure_booking_instance'] = 'AI skill: configure a booking instance';
$string['booking:skill_mod_booking_create_option'] = 'AI skill: create a booking option';
$string['booking:skill_mod_booking_create_rule_from_template'] = 'AI skill: create a booking rule from a template';
$string['booking:skill_mod_booking_create_selflearning_option'] = 'AI skill: create a self-learning option';
$string['booking:skill_mod_booking_create_slotbooking_option'] = 'AI skill: create a slot-booking option';
...
$string['booking:skill_mod_booking_search_options'] = 'AI skill: search booking options';
$string['booking:skill_mod_booking_update_option'] = 'AI skill: update a booking option';
$string['booking:skill_mod_booking_update_option_trainer'] = 'AI skill: update a booking option\'s trainer';
$string['booking:skill_mod_booking_update_rule_from_template'] = 'AI skill: update a booking rule from a template';
...
$string['bookinganswerupdated'] = 'Booking answer updated';
...
$string['bookingstrackermessagesender'] = 'Sender of messages from the bookings tracker';
$string['bookingstrackermessagesender:bookingmanager'] = 'Booking manager of the booking instance (default)';
$string['bookingstrackermessagesender:currentuser'] = 'Logged-in user (the user actually sending the message)';
$string['bookingstrackermessagesender_desc'] = 'This user is used as the sender of messages sent from the bookings tracker ("Send message", "Send message to teacher(s)", "Send message to responsible contact(s)"), so recipients can reply directly to the right person. If no valid booking manager is set, the logged-in user is used as fallback.';
...
$string['bookotherusersavailability'] = 'Availability conditions when booking other users';
$string['bookotherusersavailability:block'] = 'Block booking if availability conditions are not met';
$string['bookotherusersavailability:ignore'] = 'Ignore availability conditions';
$string['bookotherusersavailability:warn'] = 'Show a warning that needs to be confirmed';
$string['bookotherusersavailability_desc'] = 'Choose how the "Book other users" page handles availability conditions of a booking option which selected users do not meet. By default, availability conditions are ignored when booking other users.';
$string['bookotherusersavailabilityblocked'] = 'The following users were not booked because they do not meet the availability conditions of this booking option: {$a}';
$string['bookotherusersavailabilitybookanyway'] = 'Book anyway';
$string['bookotherusersavailabilitywarning'] = 'The following users do not meet the availability conditions of this booking option:';
$string['bookotherusersavailabilitywarningconfirm'] = 'Do you want to book the selected users anyway?';
...
$string['cachedef_sqlfilterrelevance'] = 'Referenced values of SQL availability filter conditions (cache)';
...
$string['cachereport'] = 'Booking: Cache report';
$string['cachereportactioncheckcron'] = 'Check that cron and adhoc tasks are running on this site.';
$string['cachereportactioncontactwb'] = 'Please contact Wunderbyte to analyse this.';
$string['cachereportactionredis'] = 'Consider mapping the affected cache definitions to a Redis store with maxmemory and an allkeys-lru eviction policy, and contact Wunderbyte.';
$string['cachereportdaybucket'] = 'Recorded day bucket of the booking time filter';
$string['cachereportdistinctstems'] = 'Distinct cache key stems in the sample';
$string['cachereportfilteractive'] = 'SQL availability filter active';
$string['cachereportfindingentrysizecritical'] = 'Very large cache objects are being stored (mean entry size {$a}).';
$string['cachereportfindingentrysizeok'] = 'Cache entry sizes are unremarkable (largest mean entry size {$a}).';
$string['cachereportfindingentrysizewarning'] = 'Large cache objects are being stored (mean entry size {$a}).';
$string['cachereportfindingkeysharingcritical'] = 'Nearly every sampled user produces their own cache entries ({$a} distinct key stems). The caches will grow with the number of users.';
$string['cachereportfindingkeysharingok'] = 'Cache keys are shared well between users ({$a} distinct key stems).';
$string['cachereportfindingkeysharingwarning'] = 'Cache keys are only partially shared between users ({$a} distinct key stems).';
$string['cachereportfindingquerytimecritical'] = 'The filtered options query is very slow ({$a} ms).';
$string['cachereportfindingquerytimeok'] = 'The filtered options query is fast ({$a} ms).';
$string['cachereportfindingquerytimewarning'] = 'The filtered options query is getting slow ({$a} ms).';
$string['cachereportfindingrolloverok'] = 'The daily cleanup of the dated table caches is up to date.';
$string['cachereportfindingrolloverwarning'] = 'The daily cleanup of the dated table caches seems to lag behind (recorded day bucket {$a->bucket}, pending purge tasks {$a->tasks}).';
$string['cachereportfindingtotalsizecritical'] = 'The affected cache definitions are very large in total ({$a}).';
$string['cachereportfindingtotalsizeok'] = 'The total size of the affected cache definitions is unremarkable ({$a}).';
$string['cachereportfindingtotalsizewarning'] = 'The affected cache definitions are getting large in total ({$a}).';
$string['cachereporthits'] = 'Cache hits';
$string['cachereportinactive'] = 'The SQL availability filter is not active, there is nothing to sample.';
$string['cachereportintro'] = 'This report measures how the booking option table caches behave on this site: how well cache keys are shared between users, how many options use the SQL availability filter, what the filter costs in query time and how large the affected cache definitions are. It is strictly read-only towards the caches and shows aggregates only.';
$string['cachereportitems'] = 'Entries';
$string['cachereportlargestinstance'] = 'Largest booking instance (options)';
$string['cachereportlogfilter'] = 'Wunderbyte table filter cache log';
$string['cachereportlogfilterdisabled'] = 'The filter cache log of local_wunderbyte_table is disabled; enable it temporarily to collect hit counts.';
$string['cachereportlogfiltersettinglink'] = 'Open the wunderbyte table settings (logfiltercaches)';
$string['cachereportmarkervalue'] = 'SQL filter marker value';
$string['cachereportmeansize'] = 'Mean entry size';
$string['cachereportnotsupported'] = 'Not supported by this store';
$string['cachereportoptioncount'] = 'Options';
$string['cachereportpendingpurgetasks'] = 'Pending dated cache purge tasks';
$string['cachereportquerytimefiltered'] = 'Options count query WITH filter (ms)';
$string['cachereportquerytimeplain'] = 'Options count query without filter (ms)';
$string['cachereportreferencedvalues'] = 'Referenced values';
$string['cachereportsampleinterpretation'] = 'A value close to the sample size means every user produces their own cache entries (the problem state); a small value means users share entries per visibility class.';
$string['cachereportsamplesize'] = 'Sample size (recently active users)';
$string['cachereportsectionconfig'] = 'Configuration';
$string['cachereportsectionfindings'] = 'Status and recommendations';
$string['cachereportsectionsample'] = 'Cache key sharing';
$string['cachereportsectionsnapshots'] = 'History (daily snapshots)';
$string['cachereportsectionstores'] = 'Cache store usage';
$string['cachereportsectiontiming'] = 'Query timing';
$string['cachereportsnapshotsempty'] = 'No snapshots recorded yet. The daily scheduled task will collect them automatically.';
$string['cachereportstatuscritical'] = 'Critical';
$string['cachereportstatusok'] = 'OK';
$string['cachereportstatuswarning'] = 'Warning';
$string['cachereporttopclasses'] = 'Largest key classes (users per key)';
$string['cachereporttotalsize'] = 'Total size';
$string['cachereportusedconditions'] = 'Conditions in use with SQL filter';
...
$string['cardoptionviewcustomfields'] = 'Show customfields in the card on the details page';
$string['cardoptionviewcustomfieldsdesc'] = 'Select the booking option customfields that you want to be shown in the card on the details page of a booking option. To change the order of the customfields, you can just change the order of the customfields <a href="/mod/booking/customfield.php" target="_blank">here</a>';
...
$string['changesplaceholdertext'] = 'Inserts a summary of the changes made to the booking option (only available for rules listening to the "booking option updated" event).';
...
$string['condition_instance'] = 'Booking instance options';
$string['condition_instance_bookingid'] = 'Booking instance';
$string['condition_instance_requiredcount'] = 'Required completed options count';
...
$string['confirmcustomformoverwrite'] = 'I am aware that saving will overwrite the form values entered by the user.';
$string['confirmcustomformoverwritequestion'] = 'Do you really want to overwrite the form values of this user? Click "Save" again to confirm, or cancel the dialog.';
...
$string['createfield'] = 'Create new dynamic dropdown field';
...
$string['customformedited'] = 'Form values edited';
$string['customformeditedhistory'] = 'The form value "{$a->label}" was changed from "{$a->oldvalue}" to "{$a->newvalue}".';
$string['customformeditordelete'] = 'Delete this form element';
$string['customformeditorinsert'] = 'Insert a new form element below';
$string['customformeditormovedown'] = 'Move form element down';
$string['customformeditormoveup'] = 'Move form element up';
...
$string['custommessagesender'] = 'Sender';
$string['custommessagesent'] = 'Custom email sent';
$string['custommessagessentto'] = 'Custom emails have been sent to the following users: {$a}';
...
$string['editcustomformvalues'] = 'Edit form values';
...
$string['enrollink:8'] = 'This enrolment link is no longer valid because the booking it belongs to has been cancelled.';
...
$string['entitytreefilter'] = 'Multilevel location filter';
$string['entitytreefilter_desc'] = 'Show the location filter as a multilevel entity tree (Location → Building → Floor → Room …) instead of a flat list, so selecting a node includes all of its sub-locations. Requires the local_entities plugin. When off, the plain-text location filter is used (unchanged).';
$string['entitytreefiltershowlocationhovercard'] = '⤷ Show hover card for deep location hierarchies';
$string['entitytreefiltershowlocationhovercard_desc'] = 'For locations in a hierarchy of three or more levels, show all superordinate levels in a small card on hover/focus of the location. When disabled, only "direct parent (entity)" is shown, without a hover card.';
$string['entitytreefiltershowlocationimages'] = '⤷ Show images in the location hover card';
$string['entitytreefiltershowlocationimages_desc'] = 'For locations in a hierarchy of three or more levels, the superordinate levels are shown in a small card on hover/focus. When enabled, the entities\' images are rendered as small thumbnails inside that card.';
$string['entitytreefiltertoplevelonly'] = '⤷ Location filter: only filter by top level';
$string['entitytreefiltertoplevelonly_desc'] = 'Offer only the first (top) level of the entity tree in the location filter. Selecting an entry filters all booking options of that entire branch; the sub-levels (e.g. single rooms) are not offered as separate filter options. Only takes effect together with the multilevel location filter.';
...
$string['error:answernotinthisoption'] = 'The booking answer (ID: {$a->answerid}) does not belong to the given booking option (ID: {$a->optionid}).';
...
$string['error:selectonlyonerow'] = 'Please select exactly one row for this action.';
...
$string['error:slotbookingallowsnodates'] = 'For slot booking, dates are only allowed when slot type is "{$a}". Please remove all dates or switch the slot type.';
...
$string['error_duplicatekey'] = 'This stored value is used more than once. Each option needs a unique value.';
$string['error_invalidshortname'] = 'The shortname may only contain lowercase letters, numbers and underscores.';
$string['error_nestedparent'] = 'Only one level of hierarchy is allowed. The selected parent is already a child, so it cannot have children of its own.';
$string['error_nofieldselected'] = 'Please choose a custom field to manage.';
$string['error_nomanageablefields'] = 'No dynamic dropdown (dynamicformat) booking custom fields were found yet. Create one below.';
$string['error_notbookingfield'] = 'The selected field is not a mod_booking option custom field.';
$string['error_notdynamicfield'] = 'The selected field is not a dynamic dropdown (dynamicformat) custom field.';
$string['error_shortnameexists'] = 'A booking custom field with this shortname already exists.';
$string['error_unknownparent'] = 'The selected parent does not exist.';
...
$string['eventslogtimefilter'] = 'Limit recent updates';
$string['eventslogtimefilter_desc'] = 'Only show change log entries ("Show recent updates") in the edit forms that are newer than the selected time span. Limiting this improves the loading time of the forms on large sites.';
$string['eventslogtimefilterhint'] = 'For better performance, this list only shows the updates of the last {$a->months} month(s). You can go to the <a href="{$a->url}">Booking plugin settings</a> to change this limit.';
$string['eventslogtimefiltermonths'] = 'Last {$a} month(s)';
$string['eventslogtimefilternolimit'] = 'No limit (show all)';
...
$string['facilityinfo'] = 'Sports facility info';
...
$string['fieldcreated'] = 'Dynamic dropdown field created.';
...
$string['forcessubscribe'] = 'Subscription for this activity has been set to forced. All potential users are subscribed and cannot unsubscribe themselves.';
...
$string['fulltextsearchcolumns'] = 'Columns to add to the full text search';
$string['fulltextsearchcolumns_help'] = 'Choose additional columns of booking options and booking custom fields that are searched by the full text search of the booking options table.';
...
$string['loadfield'] = 'Load field';
$string['loadtemplate'] = 'Error while loading the option data from the selected template.';
...
$string['manageresponsespagefields'] = 'Manage Responses Page & Bookings Tracker';
...
$string['multiplebookings_afterduration'] = 'Allow after a fixed waiting time';
$string['multiplebookings_afterlastslot'] = 'Allow after the last booked slot has ended';
$string['multiplebookings_disabled'] = 'Do not allow booking again';
...
$string['name'] = 'Name';
$string['newcategory'] = 'Create new category';
...
$string['newfieldcategory'] = 'Category';
$string['newfieldname'] = 'Field name';
$string['newfieldshortname'] = 'Field shortname';
$string['newfieldshortname_help'] = 'Lowercase letters, numbers and underscores only. Must be unique among booking custom fields.';
...
$string['nocreditsfielddefined'] = 'No user profile field for credits has been configured. Please contact the site administrator.';
...
$string['noitems'] = 'There are no additional items to book.';
...
$string['norighttoaccess'] = 'You are not allowed to access this.';
...
$string['notallowedtobookforothers'] = "Not allowed to book for others";
...
$string['notenoughcredits'] = 'You do not have enough credits.';
...
$string['openbookingdetailinsametab'] = 'Behaviour when clicking on the title of a booking option';
$string['openbookingdetailinsametab_desc'] = 'Choose how the detail view opens when a user clicks on the title of a booking option in the course list.';
$string['openbookingdetailinsametabnewwindow'] = 'Open in a new window';
$string['openbookingdetailinsametabnolink'] = 'Just text, with no link';
$string['openbookingdetailinsametabsamewindow'] = 'Open in the same window';
...
$string['page:slotbooking'] = 'Select slot';
$string['page:slotmove'] = 'Move/Cancel your slot(s)';
$string['page:subbooking'] = 'Supplementary bookings';
$string['paginationnum'] = "N. of records - pagination";
$string['participant'] = "participant";
$string['pdfahint'] = 'If "Create PDF/A-2b compliant PDFs" is enabled in the settings of the Wunderbyte Table plugin (local_wunderbyte_table), this template is rendered as PDF/A-2b: use the fonts FreeSans / FreeSerif / FreeMono (Helvetica, Arial → FreeSans; Times → FreeSerif; Courier → FreeMono) and RGB images (PNG or JPEG, no CMYK).';
$string['pdflandscape'] = 'Landscape';
$string['pdforientation'] = 'Orientation';
$string['pdfportrait'] = 'Portrait';
$string['pdftitleinstance'] = 'Booking instance name';
$string['pdftitleinstanceoption'] = 'Booking instance name: Booking option name';
$string['pdftitleoption'] = 'Booking option name';
...
$string['previewcfg_allowupdate'] = 'Allow booking updates';
$string['previewcfg_bookingpolicy'] = 'Booking policy';
$string['previewcfg_cancancelbook'] = 'Allow cancellation';
$string['previewcfg_daystonotify'] = 'Days before event to notify participants';
$string['previewcfg_daystonotifyteachers'] = 'Days before event to notify teachers';
$string['previewcfg_duration'] = 'Default duration';
$string['previewcfg_eventtype'] = 'Event type';
$string['previewcfg_intro'] = 'Description / Intro';
$string['previewcfg_maxperuser'] = 'Max bookings per user';
$string['previewcfg_name'] = 'Name';
$string['previewcfg_notifyemail'] = 'Notification email address (participants)';
$string['previewcfg_notifyemailteachers'] = 'Notification email address (teachers)';
$string['previewcfg_organizatorname'] = 'Organizer name';
$string['previewcfg_paginationnum'] = 'Options per page';
$string['previewcfg_points'] = 'Points';
$string['previewcfg_pollurl'] = 'Poll / survey URL (participants)';
$string['previewcfg_pollurlteachers'] = 'Poll / survey URL (teachers)';
$string['previewcfg_pollurlteacherstext'] = 'Poll URL link text (teachers)';
$string['previewcfg_pollurltext'] = 'Poll URL link text (participants)';
$string['previewcfg_sendmail'] = 'Send confirmation email';
$string['previewcfg_sendmailtobooker'] = 'Send email to booker';
$string['previewcfg_showinapi'] = 'Show in API';
$string['previewlabel_active'] = 'Active';
$string['previewlabel_address'] = 'Address';
$string['previewlabel_appliesto'] = 'Applies to';
$string['previewlabel_availabilitywindow'] = 'Availability window';
$string['previewlabel_bookingcloses'] = 'Booking closes';
$string['previewlabel_bookingopens'] = 'Booking opens';
$string['previewlabel_defaultprice'] = 'Default price';
$string['previewlabel_end'] = 'End';
$string['previewlabel_identifier'] = 'Identifier';
$string['previewlabel_location'] = 'Location';
$string['previewlabel_markcompleted'] = 'Mark as completed';
$string['previewlabel_name'] = 'Name';
$string['previewlabel_options'] = 'Options';
$string['previewlabel_participants'] = 'Participants';
$string['previewlabel_prices'] = 'Prices';
$string['previewlabel_question'] = 'Question';
$string['previewlabel_requestedtarget'] = 'Requested target';
$string['previewlabel_rulename'] = 'Rule name';
$string['previewlabel_seats'] = 'Seats';
$string['previewlabel_seatsperslot'] = 'Seats per slot';
$string['previewlabel_sessions'] = 'Sessions';
$string['previewlabel_slotlength'] = 'Slot length';
$string['previewlabel_sortorder'] = 'Sort order';
$string['previewlabel_start'] = 'Start';
$string['previewlabel_targetactivity'] = 'Booking activity';
$string['previewlabel_teacher'] = 'Teacher';
$string['previewlabel_template'] = 'Template';
$string['previewlabel_updateexisting'] = 'Update existing bookings';
$string['previewlabel_valid'] = 'Valid';
$string['previewlabel_visibility'] = 'Visibility';
$string['previewlabel_waitinglist'] = 'Waiting list';
$string['previewlabel_weekdays'] = 'Weekdays';
$string['previewsummary_slotbooking'] = 'Bookable {$a->window} on {$a->weekdays}, {$a->duration}-min slots, capacity {$a->seats}, {$a->validity}.';
$string['previewtitle_addpricecategory'] = 'Add price category';
$string['previewtitle_bookusers'] = 'Book users';
$string['previewtitle_bulkupdate'] = 'Update multiple booking options';
$string['previewtitle_configureinstance'] = 'Update booking instance settings';
$string['previewtitle_createoption'] = 'Create booking option';
$string['previewtitle_createrule'] = 'Create rule from template';
$string['previewtitle_createslotbooking'] = 'Create slot booking option';
$string['previewtitle_updateoption'] = 'Update booking option';
$string['previewtitle_updaterule'] = 'Update rule';
$string['previewtitle_updatetrainer'] = 'Update trainers';
$string['previewvalue_active'] = 'Active';
$string['previewvalue_alloptions'] = 'All options';
$string['previewvalue_andnmore'] = '+{$a} more';
$string['previewvalue_hidden'] = 'Hidden';
$string['previewvalue_inactive'] = 'Inactive';
$string['previewvalue_minutes'] = '{$a} minutes';
...
$string['privacy:metadata:bookingslotmoves'] = 'Pending and committed moves (rebookings) of a user\'s booked slots including the price difference';
$string['privacy:metadata:bookingslotmoves:baid'] = 'ID of the booking answer being moved';
$string['privacy:metadata:bookingslotmoves:expiry'] = 'Expiry timestamp of a pending move';
$string['privacy:metadata:bookingslotmoves:identifier'] = 'Shopping cart checkout identifier once the move is committed';
$string['privacy:metadata:bookingslotmoves:newslots'] = 'The target slots of the move';
$string['privacy:metadata:bookingslotmoves:oldslots'] = 'The given-up slots of the move';
$string['privacy:metadata:bookingslotmoves:optionid'] = 'ID of the booking option the slot move belongs to';
$string['privacy:metadata:bookingslotmoves:pricedelta'] = 'Price difference (new minus old) fixed at creation time';
$string['privacy:metadata:bookingslotmoves:status'] = 'Status of the move (pending, committed or cancelled)';
$string['privacy:metadata:bookingslotmoves:timecreated'] = 'Time the slot move was created';
$string['privacy:metadata:bookingslotmoves:timemodified'] = 'Time the slot move was last modified';
$string['privacy:metadata:bookingslotmoves:userid'] = 'User whose booked slots are moved';
$string['privacy:metadata:bookingslotstudentteacher'] = 'Teacher assigned to a student for a slot booking option';
$string['privacy:metadata:bookingslotstudentteacher:optionid'] = 'ID of the booking option';
$string['privacy:metadata:bookingslotstudentteacher:teacherid'] = 'User ID of the assigned teacher';
$string['privacy:metadata:bookingslotstudentteacher:timecreated'] = 'Time the assignment was created';
$string['privacy:metadata:bookingslotstudentteacher:timemodified'] = 'Time the assignment was last modified';
$string['privacy:metadata:bookingslotstudentteacher:userid'] = 'User (student) the teacher is assigned to';
...
$string['privacy:metadata:bookingsyncattempts'] = 'Log of individual enrolment synchronisation attempts (enrol/unenrol) per user for diagnostics';
$string['privacy:metadata:bookingsyncattempts:action'] = 'Whether the attempt was an enrolment or an unenrolment';
$string['privacy:metadata:bookingsyncattempts:bookingoptionid'] = 'ID of the booking option';
$string['privacy:metadata:bookingsyncattempts:reasoncode'] = 'Result code of the attempt';
$string['privacy:metadata:bookingsyncattempts:reasonmessage'] = 'Human-readable result message of the attempt';
$string['privacy:metadata:bookingsyncattempts:syncruleid'] = 'ID of the sync rule that triggered the attempt';
$string['privacy:metadata:bookingsyncattempts:timecreated'] = 'Time of the attempt';
$string['privacy:metadata:bookingsyncattempts:userid'] = 'User the enrol/unenrol attempt was made for';
...
$string['privacy:metadata:bookingteacherunavailability'] = 'Unavailability periods of teachers for slot booking';
$string['privacy:metadata:bookingteacherunavailability:optionid'] = 'ID of the booking option';
$string['privacy:metadata:bookingteacherunavailability:reason'] = 'Reason for the unavailability';
$string['privacy:metadata:bookingteacherunavailability:teacherid'] = 'User ID of the teacher who is unavailable';
$string['privacy:metadata:bookingteacherunavailability:timecreated'] = 'Time the unavailability was created';
$string['privacy:metadata:bookingteacherunavailability:unavailablefrom'] = 'Start of the unavailability period';
$string['privacy:metadata:bookingteacherunavailability:unavailableuntil'] = 'End of the unavailability period';
...
<li><b>turn any booking option into a flexible slot booking experience</b></li>
<li><b>let participants pick appointments in list or calendar view</b></li>
<li><b>support advanced slot rules like custom durations and examiner selection</b></li>
</ul>';
...
$string['reportrequirecourselogin'] = 'Course login required for the booked users report';
$string['reportrequirecourselogin_desc'] = 'If enabled (default), users must be enrolled in the course (or the course must allow guest access) to open the booked users report (report.php). If disabled, a site login is enough; the capability checks of the report still apply, so only teachers of the booking option or users with the required capabilities can see it.';
...
$string['savingoptiondatewentwrong'] = 'Something went wrong while saving the dates of this booking option.';
...
$string['scgfsyncheader'] = 'Automatic sync';
...
$string['selectcustomfield'] = 'Custom field';
...
$string['sendcustommsg'] = 'Send custom email';
...
$string['sendmessagetoresponsiblecontacts'] = 'Send message to responsible contact(s)';
$string['sendmessagetoteachers'] = 'Send message to teacher(s)';
...
$string['shortcode:slotbookingtypemismatch'] = 'These booking options use different slot types (e.g. fixed vs. user-defined) and cannot be shown together in one calendar. Please only combine booking options that share the same slot type.';
...
$string['signinsheetdefaults'] = 'Sign-in sheet download presets';
$string['signinsheetdefaults_desc'] = 'These settings are used for the sign-in sheet download unless they are overridden in a booking instance or have been saved for a booking option.';
...
$string['signinsheetusepluginconfig'] = 'Use sign-in sheet settings from the <a href="{$a}" target="_blank">plugin configuration</a>';
...
$string['slot_add_examiners_to_slots'] = 'Add examiners to slots';
$string['slot_allow_self_rebooking'] = 'Allow rebooking';
...
$string['slot_bookings_display_mode'] = 'Slot booking count display in option list';
$string['slot_bookings_display_mode_availableforuser'] = 'Show only slots available to the current user';
$string['slot_bookings_display_mode_bookedvscapacity'] = 'Show booked / available places (legacy)';
$string['slot_bookings_display_mode_desc'] = 'Choose how slot booking counts are shown in the booking options table.';
$string['slot_buffer_combination_mode'] = 'Adjacent buffer handling';
$string['slot_buffer_combination_mode_help'] = 'When one slot\'s cooldown meets the next slot\'s warmup: "Buffers may overlap" requires only the longer of the two; "Buffers are summed" requires the full length of both, one after the other.';
$string['slot_buffer_combination_mode_overlap'] = 'Buffers may overlap';
$string['slot_buffer_combination_mode_summed'] = 'Buffers are summed';
$string['slot_buffer_cooldown_minutes'] = 'Cool-down after slot (minutes)';
$string['slot_buffer_cooldown_minutes_help'] = 'Blocks this many minutes after a slot\'s end, e.g. for cleaning or follow-up. 0 disables the cool-down.';
$string['slot_buffer_warmup_minutes'] = 'Warm-up before slot (minutes)';
$string['slot_buffer_warmup_minutes_help'] = 'Blocks this many minutes before a slot\'s start, e.g. for preparation. 0 disables the warm-up.';
$string['slot_calendar_event_title'] = 'Occupancy: {$a}';
$string['slot_calendar_no_booked_slots'] = 'No booked slots on this day.';
$string['slot_calendar_occupancy'] = 'Occupancy';
$string['slot_calendar_ownbooking'] = 'Your booking';
$string['slot_calendar_select_slot'] = 'Select a slot to view booked students.';
$string['slot_calendar_slots_header'] = 'Slots';
$string['slot_calendar_students'] = 'Booked students';
$string['slot_calendar_teachers'] = 'Booked examiners';
$string['slot_calendar_title'] = 'Slot calendar';
$string['slot_cancel_heading'] = 'Cancel individual slots';
$string['slot_cancel_select'] = 'Select the booked slots you want to cancel. Slots past their deadline cannot be cancelled.';
$string['slot_cancel_submit'] = 'Cancel selected slots';
$string['slot_cancelled_event_description'] = 'User with id {$a->adminid} cancelled slot booking answer {$a->baid} (option {$a->optionid}) for user {$a->userid} with {$a->slotcount} slot(s).';
$string['slot_cancelled_event_name'] = 'Booking slot cancelled';
$string['slot_change_deadline_0'] = 'Until slot start';
$string['slot_change_deadline_120'] = 'Until 2 hours before slot start';
$string['slot_change_deadline_1440'] = 'Until 24 hours before slot start';
$string['slot_change_deadline_30'] = 'Until 30 minutes before slot start';
$string['slot_change_deadline_60'] = 'Until 1 hour before slot start';
$string['slot_change_deadline_720'] = 'Until 12 hours before slot start';
$string['slot_change_deadline_inherit'] = 'Use default';
$string['slot_change_deadline_m30'] = 'Until 30 minutes after slot start';
$string['slot_change_deadline_m60'] = 'Until 1 hour after slot start';
$string['slot_change_deadline_minutes'] = 'Move/cancel deadline (relative to slot start)';
$string['slot_change_deadline_minutes_desc'] = 'Site-wide default in minutes for the slot move/cancel deadline, relative to each slot start (positive = before start, 0 = until start, negative = after start). Booking instances and options can override this.';
$string['slot_change_deadline_minutes_help'] = 'Until when participants may move or cancel a booked slot, relative to that slot\'s start. Each slot is evaluated individually. "Use default" inherits the booking instance or site default.';
$string['slot_closing_time'] = 'Closing time (HH:MM)';
$string['slot_custom_duration'] = 'Duration';
$string['slot_custom_duration_step_minutes'] = 'Slot duration step (minutes)';
$string['slot_custom_duration_step_minutes_help'] = 'Granularity of the selectable slot length between the minimal and maximal slot length. For example, with a minimum of 15 minutes, a maximum of 30 minutes, and a step of 5 minutes, users can choose a duration of 15, 20, 25 or 30 minutes.';
...
$string['slot_day_sun'] = 'Sunday';
$string['slot_day_thu'] = 'Thursday';
$string['slot_day_tue'] = 'Tuesday';
...
$string['slot_error_max_slots_reached'] = 'You have already reached the maximum number of slots you can book for this option.';
...
$string['slot_error_selection_overlap'] = 'The selected slots overlap each other. Please choose non-overlapping slots.';
$string['slot_error_selection_required'] = 'Please select a valid slot.';
$string['slot_error_selection_toomany'] = 'Please select no more than {$a} slot(s).';
$string['slot_error_teacher_required'] = 'Please select an examiner.';
$string['slot_error_timeformat'] = 'Please use HH:MM format.';
...
$string['slot_max_slots_per_user'] = 'Max slots per user';
$string['slot_max_slots_per_user_help'] = 'The total number of separate slots a user may hold for this option at once (e.g. buying several slots as individual purchases over time). This is independent of the instance-level "Allow to book again" setting: that setting only controls whether a user may re-book after their booking has ended or after a wait time, and does not limit how many slots they can hold. Both settings can be combined, but neither one substitutes for the other.';
$string['slot_move_action'] = 'Move slot';
$string['slot_move_booked_label'] = 'Booked';
$string['slot_move_current_booking'] = 'Currently booked';
$string['slot_move_event_description_multi'] = 'User with id {$a->adminid} moved booking answer {$a->baid} (option {$a->optionid}) for user {$a->userid}. Moved slots from {$a->oldslots} to {$a->newslots}. Reason: {$a->reason}';
$string['slot_move_event_description_single'] = 'User with id {$a->adminid} moved booking answer {$a->baid} (option {$a->optionid}) for user {$a->userid}. Moved slot from {$a->oldslots} to {$a->newslots}. Reason: {$a->reason}';
$string['slot_move_event_name'] = 'Booking slot moved';
$string['slot_move_locked_label'] = 'Locked (deadline passed)';
...
$string['slot_no_open_slots'] = 'There are currently no open slots available.';
$string['slot_nosubscribe'] = 'Because slot booking is enabled for this option, users cannot be booked here.';
$string['slot_nosubscribe_cashier'] = 'Bookings can be made via the cashier.';
$string['slot_nosubscribe_unenrol'] = 'Users can be unenrolled from this option in the list on the responses page.';
$string['slot_opening_time'] = 'Opening time (HH:MM)';
$string['slot_price_base_info'] = 'For slot booking, the initial price in this section is the base price for all slots. Individual slots can then receive their own prices via the slot rules editor.';
$string['slot_price_source_info'] = 'Slot pricing uses the regular option price configured in the price section.';
$string['slot_rebook'] = 'Rebook';
$string['slot_rebook_action'] = 'Rebook slot';
$string['slot_rebook_deadline_passed'] = 'The rebooking deadline has passed.';
$string['slot_rebook_not_allowed'] = 'You are not allowed to rebook this slot.';
$string['slot_rebook_notification_teacher_body'] = 'Participant {$a->participant} has rebooked from {$a->oldtime} to {$a->newtime}.';
$string['slot_rebook_notification_teacher_subject'] = 'A participant has rebooked an appointment';
$string['slot_rebook_notification_user_body'] = 'You have moved your appointment.\nNew time: {$a->newtime}';
$string['slot_rebook_notification_user_subject'] = 'Your appointment has been moved';
$string['slot_rebook_reason'] = 'Reason (optional)';
$string['slot_rebook_slot_started'] = 'A slot that has already started cannot be given up.';
$string['slot_rebook_success'] = 'Slot successfully rebooked.';
$string['slot_report_numslots'] = 'Booked slots';
$string['slot_report_price'] = 'Slot price paid';
$string['slot_report_teachers'] = 'Assigned examiners';
$string['slot_rule_active_range'] = 'Active range';
$string['slot_rule_activefrom'] = 'Active from';
$string['slot_rule_activeuntil'] = 'Active until';
$string['slot_rule_delete_confirm'] = 'Do you really want to delete this slot rule?';
$string['slot_rule_deleted'] = 'Slot rule deleted.';
$string['slot_rule_editor_formheader'] = 'Create or edit slot rule';
$string['slot_rule_editor_label'] = 'Slot rules';
$string['slot_rule_editor_open'] = 'Open slot rule editor';
$string['slot_rule_editor_savefirst'] = 'Save this booking option first to manage slot rules.';
$string['slot_rule_editor_title'] = 'Slot rule editor';
...
$string['slot_rule_pricemode'] = 'Price mode';
$string['slot_rule_pricemode_absolute'] = 'Absolute value';
$string['slot_rule_pricemode_delta'] = 'Delta';
$string['slot_rule_pricemode_factor'] = 'Factor';
$string['slot_rule_pricevalue'] = 'Price value';
$string['slot_rule_priority'] = 'Priority';
$string['slot_rule_saved'] = 'Slot rule saved.';
$string['slot_rule_tables_missing'] = 'Slot rule tables are not available yet. Please run the plugin upgrade first.';
$string['slot_rule_timerangeend'] = 'End time (HH:MM)';
$string['slot_rule_timerangestart'] = 'Start time (HH:MM)';
$string['slot_rule_timewindow'] = 'Time window';
$string['slot_rule_type'] = 'Rule type';
$string['slot_rule_type_closed'] = 'Closed slots';
$string['slot_rule_type_price'] = 'Price adjustment';
$string['slot_rule_useactiverange'] = 'Limit by active date range';
$string['slot_rule_weekdays'] = 'Weekdays';
$string['slot_select_required'] = 'Please select an available slot first.';
$string['slot_selection'] = 'Slot';
$string['slot_session_dates_hint'] = 'If you choose "From option dates (sessions)", define the actual slot times in the Dates section below.';
$string['slot_settings_header'] = 'Slot Booking Settings';
$string['slot_student_teacher_assignments'] = 'Student examiner assignments';
$string['slot_student_teacher_assignments_desc'] = 'Assign one or more examiners from this option\'s examiner pool to each enrolled student.';
$string['slot_student_teacher_assignments_no_students'] = 'No enrolled students found in this course.';
$string['slot_student_teacher_assignments_no_teachers'] = 'No examiners are configured in this option\'s examiner pool.';
$string['slot_student_teacher_assignments_saved'] = 'Student examiner assignments were saved.';
$string['slot_student_teacher_assignments_teachers'] = 'Assigned examiners';
$string['slot_tab_book'] = 'Book another slot';
$string['slot_tab_move'] = 'Move your slot';
$string['slot_teacher_pool'] = 'Examiner pool';
$string['slot_teacher_unavailability'] = 'Examiner unavailability';
$string['slot_teacher_unavailability_for'] = 'Unavailability for {$a}';
$string['slot_teachers_required'] = 'Examiners required per slot';
$string['slot_type'] = 'Slot type';
$string['slot_type_change_confirm'] = 'I understand and confirm changing the option type.';
$string['slot_type_change_warning'] = 'This slot option already has booking answers. Changing the option type may invalidate existing slot bookings. Please confirm to continue.';
$string['slot_type_fixed'] = 'Fixed';
$string['slot_type_rolling'] = 'Rolling';
$string['slot_type_session'] = 'From option dates (sessions)';
$string['slot_type_userdefined'] = 'User-defined';
$string['slot_unavailability_blocks'] = 'Unavailability blocks';
$string['slot_unavailability_helptext'] = 'Pick slots to mark in the selected mode. In availability mode, picked slots remain available and all other slots in scope become unavailable.';
$string['slot_unavailability_mode'] = 'Marking mode';
$string['slot_unavailability_mode_availability'] = 'Mark available slots (green)';
$string['slot_unavailability_mode_unavailability'] = 'Mark unavailable slots (red)';
$string['slot_unavailability_no_slots'] = 'No slots found in the selected scope.';
$string['slot_unavailability_scope'] = 'Scope';
$string['slot_unavailability_scope_currentfallback'] = 'Current slot option';
$string['slot_unavailability_scope_instance'] = 'Booking instance (all slot options)';
$string['slot_unavailability_scope_option'] = 'Specific slot option';
$string['slot_unavailability_scope_system'] = 'System (all bookings using this teacher)';
$string['slot_unavailability_scope_targetoption'] = 'Slot option in scope';
$string['slot_unavailability_viewmode'] = 'Selection view';
$string['slot_update_button'] = 'Update my booking';
$string['slot_update_confirm_added'] = 'Added';
$string['slot_update_confirm_cancel_all'] = 'Your whole booking will be cancelled.';
$string['slot_update_confirm_moved'] = 'Moved to';
$string['slot_update_confirm_net_charge'] = 'Additional payment due: {$a}';
$string['slot_update_confirm_net_refund'] = 'You will be refunded {$a} as credit.';
$string['slot_update_confirm_removed'] = 'Cancelled';
$string['slot_update_confirm_save'] = 'Confirm update';
$string['slot_update_confirm_title'] = 'Confirm booking update';
$string['slot_update_delta_label'] = 'Price change';
$string['slot_update_locked_kept'] = 'A locked slot (past its deadline) cannot be cancelled or moved.';
$string['slot_update_no_add'] = 'You cannot add slots here – use "Book another slot" for that. This tab only edits your current slots.';
$string['slot_update_tab'] = 'Move/Cancel your slot(s)';
$string['slot_update_unavailable'] = 'A selected slot is no longer available.';
$string['slot_valid_from'] = 'Valid from';
$string['slot_valid_until'] = 'Valid until';
$string['slot_week_overview'] = 'Week overview';
$string['slotbooking'] = 'Slot booking settings';
$string['slotbooking_invert_selection'] = 'Invert selection';
$string['slotbooking_no_custom_day_available'] = 'No slot is available for this booking option on this day.';
$string['slotbooking_prepage_description'] = 'Please choose one available slot before continuing with the booking.';
$string['slotbooking_sidebar_title'] = 'Booking options';
$string['slotbooking_switched_option'] = 'Your previous slot selection was cleared because you can only book slots from one option at a time.';
$string['slotbookingactive'] = 'Enable slot booking';
$string['slotbookingactive_desc'] = 'Enable the slot booking feature site-wide. When off, slot booking is unavailable everywhere (option type, booking flow, agent skill and slot pages), even with a PRO licence.';
$string['slotbookingdateswarning'] = 'Dates are not used for this slot type. Option dates are only allowed when slot type is "From option dates (sessions)".';
$string['slotmove_cartitem_description'] = 'Slot change from {$a->old} to {$a->new}';
$string['slotmove_cartitem_title'] = 'Rebooking: {$a}';
$string['slotmove_refunded'] = 'You have been refunded {$a} as credit.';
$string['slotsbooked'] = 'Booked slots from a slot-booked event.';
$string['slotscancelled'] = 'Cancelled slots from a slot-cancelled event.';
$string['slotsmovedfrom'] = 'Original slots (moved from) of a slot-moved event.';
$string['slotsmovedto'] = 'New slots (moved to) of a slot-moved event.';
...
$string['subscribealreadybooked'] = '(is already booked)';
...
$string['syncactionenrol'] = 'Enrol';
$string['syncactionunenrol'] = 'Unenrol';
$string['syncactivaterule'] = 'Activate sync rule';
$string['syncaddrule'] = 'Add sync rule';
$string['syncapplycurrentmembers'] = 'Apply rule immediately to current source members';
$string['synccohortgroupenrolmentblocked'] = 'Sync enrolment was blocked by availability conditions or capacity.';
$string['syncconditionpolicy'] = 'Availability conditions';
$string['syncconditionpolicy_override'] = 'Override (ignore availability conditions)';
$string['syncconditionpolicy_respect'] = 'Respect (skip blocked users)';
$string['syncdeletemodemanual'] = 'Convert to manual bookings (reset rule ownership)';
$string['syncdeletemodeorphan'] = 'Leave untouched (keep rule ID reference, rule no longer active)';
$string['syncdeletemodeunenrol'] = 'Unenrol affected users (set their booking answers to deleted)';
$string['syncdeleterule'] = 'Delete sync rule';
$string['syncdiagnosticsheader'] = 'Sync diagnostics (recent attempts)';
$string['syncdisableallrules'] = 'Disable all sync rules';
$string['synceditrule'] = 'Edit sync rule';
$string['syncenabled'] = 'Enable automatic sync for this subscription';
$string['syncenrolaction'] = 'Enrol users when added to source';
...
$string['syncreasonblockednotsyncowned'] = 'Booking not owned by this sync rule';
$string['syncreasonok'] = 'Success';
$string['syncruleactionrequired'] = 'Select at least one sync action (enrol or unenrol).';
$string['syncruleactivateconfirm'] = 'Activate this sync rule. You can optionally run the rule immediately against the current source membership.';
$string['syncruleactivated'] = 'Sync rule activated. Retroactive sync checked {$a->enrolattempted} enrolment(s) and {$a->unenrolattempted} unenrolment(s).';
$string['syncruleactivateimpact'] = 'If you run retroactive sync now, up to {$a->currentmembers} current source member(s) will be checked for enrolment and {$a->ownedoutsidesource} rule-owned booking(s) outside the source will be checked for unenrolment.';
$string['syncruleactivateretroactive'] = 'Trigger retroactive sync now';
$string['syncruleactivateretroactivedesc'] = 'Enrol current source members and unenrol users still owned by this rule but no longer in the current cohort/group.';
$string['syncruleactive'] = 'Active';
$string['syncrulealreadyexists'] = 'A sync rule for this source already exists.';
$string['syncruledeleteconfirm'] = 'This sync rule will be permanently deleted. Choose how to handle bookings created by this rule.';
$string['syncruledeleted'] = 'Sync rule deleted. {$a} linked booking(s) were affected.';
$string['syncruledeleteimpact'] = 'This rule currently owns {$a} booking answer(s).';
$string['syncruledeletemode'] = 'How to handle existing bookings';
$string['syncrulesaved'] = 'Sync rule saved.';
$string['syncrulesconfigured'] = 'Configured sync rules';
$string['syncrulesdisabled'] = 'All sync rules disabled.';
$string['syncrulesource'] = 'Source';
$string['syncsourceselect'] = 'Source';
$string['syncsourcetype'] = 'Source type';
$string['syncsourcetypecohort'] = 'Cohort';
$string['syncsourcetypegroup'] = 'Group';
$string['syncunenrolaction'] = 'Unenrol users when removed from source';
...
$string['transferconfirmlabel'] = 'I understand the warnings above and want to transfer the selected users anyway.';
$string['transferconfirmrequired'] = 'Please confirm that you want to transfer despite the warnings above.';
...
$string['transferoptiontypedefault'] = 'Booking option with dates';
$string['transferproblem'] = 'The following could not be transferred due to booking option limitation or user limitation: {$a}';
$string['transfersameoption'] = 'Please select a booking option other than the one the users are currently booked into.';
$string['transfersuccess'] = 'The users have successfully been transferred to the new booking option';
$string['transfertargetoption'] = 'Target booking option';
$string['transfertargetoption_help'] = 'Search for the booking option you want to transfer the selected users into. The suggestions show the option title (with its prefix), the option id and the booking instance the option belongs to. You can transfer into options of other booking instances too.';
$string['transferusers'] = 'Transfer users';
$string['transferwarningcustomform'] = 'At least one of the selected users filled out a custom form for the current booking option. This form data will be lost when transferring.';
$string['transferwarningheading'] = 'Please review the following before transferring:';
$string['transferwarningprice'] = 'The target booking option has a different price ({$a}). Transferring does not adjust anything already paid.';
$string['transferwarningtype'] = 'The target booking option is of a different type (from "{$a->sourcetype}" to "{$a->targettype}").';
...
$string['wrongfile'] = 'Wrong file. Please choose a valid file to import.';
...
$string['wrongpagenumberforprebookingpage'] = 'Error: Wrong page number for pre-booking page.';
$string['wrongstructureofsearchparams'] = 'The structure of the search parameters is invalid.';
