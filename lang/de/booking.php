...
$string['addtocalendarlockedhint_link'] = 'in den Plugin-Einstellungen entsperren';
...
$string['agent_booking_blocker_followup_bookingpolicy'] = 'Bitte bestätigen Sie, wie die Zustimmung zur Buchungsrichtlinie übermittelt werden soll.';
$string['agent_booking_blocker_followup_customform'] = 'Bitte geben Sie die erforderlichen Werte für das benutzerdefinierte Formular an, die übermittelt werden sollen.';
$string['agent_booking_blocker_followup_customform_bookingpolicy'] = 'Bitte geben Sie die Werte für das benutzerdefinierte Formular an und bestätigen Sie, wie die Zustimmung zur Buchungsrichtlinie übermittelt werden soll.';
$string['agent_booking_blocker_followup_generic'] = 'Bitte geben Sie die erforderlichen Informationen an, um die blockierende(n) Bedingung(en) zu erfüllen.';
$string['agent_booking_book_users_booked'] = '{$a->count} Benutzer in Option id={$a->optionid} gebucht: {$a->userids}.';
$string['agent_booking_book_users_option_resolve_failed'] = 'Buchungsoption konnte nicht aufgelöst werden.';
$string['agent_booking_book_users_required_bookusersquery'] = 'Aus der angegebenen Abfrage konnten keine Benutzer ermittelt werden. Bitte geben Sie mindestens einen Benutzer per Name, E-Mail oder ID an.';
$string['agent_booking_book_users_soft_block'] = 'Benutzer {$a->userid} kann sich nicht selbst buchen ({$a->descriptions}), Sie haben jedoch das Recht, für ihn zu buchen.';
$string['agent_booking_book_users_soft_block_confirm'] = 'Möchten Sie wirklich fortfahren?';
$string['agent_booking_booked_users_label'] = 'Gebuchte Nutzer:innen';
$string['agent_booking_bulk_update_bookusersquery_unsupported'] = 'Feld "bookusersquery" wird für booking.bulk_update_options nicht unterstützt. Verwenden Sie booking.update_option für pro-Option Nutzerbuchungen.';
...
$string['agent_booking_cohort_no_match'] = 'Keine Kohorte für die Suchanfrage "{$a}" gefunden.';
$string['agent_booking_competency_multiple_match'] = 'Mehrere Kompetenzen stimmen mit "{$a->query}" überein: {$a->candidates}.';
$string['agent_booking_competency_no_match'] = 'Keine Kompetenz für die Suchanfrage "{$a}" gefunden.';
$string['agent_booking_course_no_shortname'] = 'Aufgelöster Kurs "{$a}" hat keinen Kurznamen.';
$string['agent_booking_create_normal_missing_duration'] = 'Für den normalen Buchungstyp bitte eine Dauer oder ein Enddatum/-uhrzeit angeben.';
$string['agent_booking_create_normal_missing_location'] = 'Für den normalen Buchungstyp bitte einen Ort oder eine Adresse angeben.';
$string['agent_booking_create_normal_missing_maxanswers'] = 'Für den normalen Buchungstyp bitte die maximale Teilnehmerzahl angeben.';
$string['agent_booking_create_normal_missing_startdate'] = 'Für den normalen Buchungstyp bitte ein Startdatum/-uhrzeit oder Datumsbereiche angeben.';
$string['agent_booking_create_normal_missing_teacher'] = 'Für den normalen Buchungstyp bitte einen Lehrenden oder eine Lehrenden-E-Mail angeben.';
...
$string['agent_booking_create_option_exists_multiple'] = 'Eine oder mehrere Buchungsoptionen mit exakt diesem Titel existieren bereits: {$a}. Möchten Sie stattdessen eine davon aktualisieren?';
$string['agent_booking_create_option_exists_single'] = 'Eine Buchungsoption mit exakt diesem Titel existiert bereits (id={$a}). Möchten Sie diese Option statt einer Neuanlage aktualisieren?';
...
$string['agent_booking_create_selflearning_missing_duration'] = 'Für den Selbstlerntyp bitte eine Dauer (in Sekunden) angeben.';
$string['agent_booking_create_selflearning_missing_maxanswers'] = 'Für den Selbstlerntyp bitte die maximale Teilnehmerzahl angeben.';
$string['agent_booking_create_selflearning_missing_teacher'] = 'Für den Selbstlerntyp bitte einen Lehrenden oder eine Lehrenden-E-Mail angeben.';
$string['agent_booking_create_slotbooking_missing_custom_duration'] = 'Für den benutzerdefinierten Slot-Typ bitte die maximale Slot-Dauer in Sekunden angeben (slot_custom_max_duration).';
$string['agent_booking_create_slotbooking_missing_duration'] = 'Für den Slot-Buchungstyp bitte die Slot-Dauer in Minuten angeben (slot_duration_minutes).';
$string['agent_booking_create_slotbooking_missing_participants'] = 'Für den Slot-Buchungstyp bitte angeben, wie viele Personen jeden Slot buchen können (slot_max_participants_per_slot).';
$string['agent_booking_create_slotbooking_missing_timewindow'] = 'Für den Slot-Buchungstyp bitte die täglichen Oeffnungs- und Schliesszeiten angeben (slot_opening_time, slot_closing_time).';
$string['agent_booking_create_slotbooking_missing_validity'] = 'Für den Slot-Buchungstyp bitte angeben, ab wann und bis wann Slots verfügbar sein sollen (slot_valid_from, slot_valid_until).';
$string['agent_booking_create_slotbooking_missing_weekday'] = 'Für den Slot-Buchungstyp bitte angeben, an welchen Wochentag(en) Slots angeboten werden sollen (slot_day_1=Montag ... slot_day_7=Sonntag). Nur die gewünschten Tage auf true setzen; alle anderen weglassen oder auf false setzen.';
...
$string['agent_booking_diagnose_cancel_reason_activity_completed'] = 'Stornieren ist nicht möglich, weil diese Buchungsaktivität für Sie bereits abgeschlossen ist.';
$string['agent_booking_diagnose_cancel_reason_activity_completed_other'] = 'Stornieren ist nicht möglich, weil diese Buchungsaktivität für die ausgewählte Person bereits abgeschlossen ist.';
...
$string['agent_booking_diagnose_cancel_reason_concrete_option_canceluntil_passed'] = 'Konkrete Einstellung: booking_option.json.canceluntil = {$a->timestamp} ({$a->date}) liegt in der Vergangenheit. Admin-Aktion: canceluntil auf einen zukünftigen Zeitpunkt setzen oder diese Restriktion entfernen.';
...
$string['agent_booking_diagnose_cancel_reason_coolingoff_active'] = 'Eine Cooling-off-Phase ist aktiv ({$a} Sekunden), daher ist Stornieren vorübergehend blockiert.';
...
$string['agent_booking_diagnose_cancel_reason_not_booked'] = 'Sie sind für diese Option aktuell nicht gebucht.';
$string['agent_booking_diagnose_cancel_reason_not_booked_other'] = 'Die ausgewählte Person ist für diese Option aktuell nicht gebucht.';
...
$string['agent_booking_diagnose_cancel_reason_price_without_shopping_cart'] = 'Diese Option verwendet Preise, aber local_shopping_cart ist nicht verfügbar; dadurch ist Stornieren deaktiviert.';
$string['agent_booking_diagnose_cancel_reason_reserved_state'] = 'Sie haben derzeit nur einen Reservierungsstatus; dieser Stornoablauf ist damit nicht verfügbar.';
$string['agent_booking_diagnose_cancel_reason_reserved_state_other'] = 'Die ausgewählte Person hat derzeit nur einen Reservierungsstatus; dieser Stornoablauf ist damit nicht verfügbar.';
$string['agent_booking_diagnose_cancel_reason_shopping_cart_denies_cancel'] = 'Shopping-Cart-Regeln blockieren die Stornierung für diese Option.';
$string['agent_booking_diagnose_cancel_reason_waitinglist_confirmation_pending'] = 'Sie stehen auf der Warteliste mit bestätigungsbezogenem Wartelistenstatus; dadurch ist Stornieren blockiert.';
$string['agent_booking_diagnose_cancel_reason_waitinglist_no_confirmation_flow'] = 'Sie stehen auf der Warteliste ohne Bestätigungsablauf und die Option ist nicht voll; dadurch ist diese Stornoaktion blockiert.';
$string['agent_booking_diagnose_cancel_required_question'] = 'Das Feld "question" ist für diagnose_cancellation_issue erforderlich.';
$string['agent_booking_diagnose_cancellation_user_resolve_failed'] = 'Zielbenutzer konnte nicht aufgelöst werden.';
$string['agent_booking_diagnose_error_last_preview_none'] = 'Es gibt keine kürzlich vorgeschlagene Option, auf die verwiesen werden kann.';
$string['agent_booking_diagnose_error_option_not_in_instance'] = 'Die angegebene optionid gehört nicht zu dieser Buchungsinstanz.';
$string['agent_booking_diagnose_error_option_resolve'] = 'Die Buchungsoption konnte nicht aufgelöst werden.';
$string['agent_booking_diagnose_error_user_not_found'] = 'Kein Benutzer passt zu "{$a}". Bitte geben Sie den genauen Namen, die E-Mail oder die Nutzer-ID an.';
$string['agent_booking_diagnose_error_user_resolution_failed'] = 'Der Benutzer konnte aus "{$a}" nicht ermittelt werden. Bitte geben Sie den genauen Namen, die E-Mail oder die Nutzer-ID an.';
$string['agent_booking_diagnose_intro_checked_option'] = 'Ich habe Ihre Buchungssituation für "{$a}" geprüft.';
$string['agent_booking_diagnose_intro_checked_option_other'] = 'Ich habe die Buchungssituation der ausgewählten Person für "{$a}" geprüft.';
...
$string['agent_booking_diagnose_reason_banned_username_concrete'] = 'Konkrete Einstellung: booking.banusernames enthält diesen Benutzernamen. Admin-Aktion: Den Benutzernamen aus dem Feld "Gesperrte Benutzernamen" in den Instanzeinstellungen entfernen.';
$string['agent_booking_diagnose_reason_banned_username_other'] = 'Der Benutzername der ausgewählten Person steht auf der Sperrliste dieser Buchungsinstanz.';
$string['agent_booking_diagnose_reason_cannot_book_already_booked'] = 'Sie sind bereits gebucht, daher ist eine weitere normale Buchung nicht verfügbar.';
$string['agent_booking_diagnose_reason_cannot_book_already_booked_other'] = 'Die ausgewählte Person ist bereits gebucht, daher ist eine weitere normale Buchung nicht verfügbar.';
...
$string['agent_booking_diagnose_reason_cannot_book_waitinglist_available'] = 'Die regulären Plätze sind voll, aber auf der Warteliste sind noch Plätze frei.';
$string['agent_booking_diagnose_reason_cannot_book_waitinglist_full'] = 'Die Warteliste ist ebenfalls voll.';
$string['agent_booking_diagnose_reason_instance_disablebooking'] = 'Das Buchen ist für diese gesamte Buchungsinstanz aktuell deaktiviert.';
$string['agent_booking_diagnose_reason_instance_disablebooking_concrete'] = 'Konkrete Einstellung: booking.json.disablebooking = 1. Admin-Aktion: In den Instanzeinstellungen "Buchen für diese Instanz deaktivieren" deaktivieren.';
...
$string['agent_booking_diagnose_reason_maxperuser_exceeded_concrete'] = 'Konkrete Einstellung: booking.maxperuser = {$a->max}. Aktive Buchungen dieser Person in dieser Instanz: {$a->current}. Admin-Aktion: Eine bestehende Buchung stornieren oder maxperuser in den Instanzeinstellungen erhöhen.';
...
$string['agent_booking_diagnose_reason_missing_email_booked'] = 'Sie sind für diese Option gebucht; eine fehlende Buchung erklärt die fehlende E-Mail daher nicht.';
$string['agent_booking_diagnose_reason_missing_email_booked_other'] = 'Die ausgewählte Person ist für diese Option gebucht; eine fehlende Buchung erklärt die fehlende E-Mail daher nicht.';
$string['agent_booking_diagnose_reason_missing_email_limitations'] = 'Diese Selbstprüfung kann nicht nachweisen, ob eine E-Mail tatsächlich gesendet oder zugestellt wurde.';
$string['agent_booking_diagnose_reason_missing_email_manager_check'] = 'Bei Bedarf kann eine verantwortliche Person Mailvorlagen, Regeln und die geplante Mail-Warteschlange prüfen.';
$string['agent_booking_diagnose_reason_missing_email_not_booked'] = 'Sie sind für diese Option derzeit nicht gebucht.';
$string['agent_booking_diagnose_reason_missing_email_not_booked_other'] = 'Die ausgewählte Person ist für diese Option derzeit nicht gebucht.';
$string['agent_booking_diagnose_reason_missing_email_waitinglist'] = 'Sie stehen auf der Warteliste, wodurch andere Benachrichtigungen als bei einer bestätigten Buchung möglich sind.';
$string['agent_booking_diagnose_reason_missing_email_waitinglist_other'] = 'Die ausgewählte Person steht auf der Warteliste, wodurch andere Benachrichtigungen als bei einer bestätigten Buchung möglich sind.';
...
$string['agent_booking_diagnose_reason_not_enrolled'] = 'Sie sind nicht in den Kurs eingeschrieben, der diese Buchungsaktivität enthält. Das ist ein wichtiges Signal, aber nicht immer allein ein Blockierungsgrund.';
$string['agent_booking_diagnose_reason_not_enrolled_concrete'] = 'Konkreter Zustand: Benutzer (id={$a}) ist nicht im Kurs eingeschrieben. Admin-Aktion: Vor einer finalen Schlussfolgerung zunächst Options-Bedingungen und Capability-Setup prüfen.';
$string['agent_booking_diagnose_reason_not_enrolled_other'] = 'Die ausgewählte Person ist nicht in den Kurs eingeschrieben, der diese Buchungsaktivität enthält. Das ist ein wichtiges Signal, aber nicht immer allein ein Blockierungsgrund.';
$string['agent_booking_diagnose_reason_not_enrolled_supplementary'] = 'Ergänzender Hinweis: Eine fehlende Kurseinschreibung bedeutet nicht zwingend, dass eine Buchung unmöglich ist.';
$string['agent_booking_diagnose_reason_option_hidden_from_list'] = 'Diese Buchungsoption ist aus der Buchungsliste ausgeblendet (invisible = 2), kann aber über einen direkten Link aufgerufen werden.';
...
$string['agent_booking_diagnose_reason_status_booked'] = 'Sie haben für diese Option bereits eine bestätigte Buchung.';
$string['agent_booking_diagnose_reason_status_booked_other'] = 'Die ausgewählte Person hat für diese Option bereits eine bestätigte Buchung.';
$string['agent_booking_diagnose_reason_status_notbooked'] = 'Für Sie existiert derzeit kein Buchungseintrag für diese Option.';
$string['agent_booking_diagnose_reason_status_notbooked_other'] = 'Für die ausgewählte Person existiert derzeit kein Buchungseintrag für diese Option.';
$string['agent_booking_diagnose_reason_status_notifylist'] = 'Sie stehen auf der Benachrichtigungsliste, sind aber nicht gebucht.';
$string['agent_booking_diagnose_reason_status_notifylist_other'] = 'Die ausgewählte Person steht auf der Benachrichtigungsliste, ist aber nicht gebucht.';
$string['agent_booking_diagnose_reason_status_reserved'] = 'Sie haben derzeit nur eine Reservierung, aber keine bestätigte Buchung.';
$string['agent_booking_diagnose_reason_status_reserved_other'] = 'Die ausgewählte Person hat derzeit nur eine Reservierung, aber keine bestätigte Buchung.';
$string['agent_booking_diagnose_reason_status_waitinglist'] = 'Sie stehen für diese Option aktuell auf der Warteliste.';
$string['agent_booking_diagnose_reason_status_waitinglist_other'] = 'Die ausgewählte Person steht für diese Option aktuell auf der Warteliste.';
$string['agent_booking_diagnose_required_question'] = 'Das Feld "question" ist für diagnose_booking_issue erforderlich.';
...
$string['agent_booking_diagnose_user_optionquery_unresolved'] = 'Ich konnte "{$a}" keiner eindeutigen Buchungsoption zuordnen und zeige daher die Übersicht aller Buchungen. Geben Sie den genauen Optionstitel oder die Options-ID an, um die Diagnose zu fokussieren.';
$string['agent_booking_diagnose_user_report_option'] = 'Buchungsdiagnose für "{$a->option}": Aktueller Status ist "{$a->status}".';
$string['agent_booking_diagnose_user_report_overview'] = 'Buchungsübersicht: {$a->booked} aktive Buchung(en), {$a->completed} abgeschlossen.';
$string['agent_booking_diagnose_user_required'] = 'Wessen Buchung soll ich prüfen? Bitte geben Sie einen Namen, eine E-Mail oder eine Nutzer-ID an.';
...
$string['agent_booking_invalid_course_module'] = 'Ungültiges Kursmodul.';
$string['agent_booking_list_option_properties_found'] = '{$a} Buchungsoptions-Eigenschaft(en) gefunden.';
$string['agent_booking_no_instance_in_scope'] = 'Im aktuellen Kontext (z. B. Dashboard) gibt es keine Buchungsaktivität. Bitte sagen Sie mir, welchen Kurs oder welche Buchungsaktivität Sie meinen.';
$string['agent_booking_no_instance_in_scope_courses'] = 'Im aktuellen Kontext gibt es keine Buchungsaktivität — hier können Sie buchen:';
...
$string['agent_booking_option_target_ambiguous'] = 'Die Option „{$a}" existiert in mehreren Buchungsaktivitäten. Bitte sagen Sie mir, für welche Aktivität sie gelten soll (oder verwenden Sie die Options-ID). Kandidaten:';
$string['agent_booking_previouslybookedquery_resolve_failed'] = 'previouslybookedquery konnte nicht aufgelöst werden.';
$string['agent_booking_price_negative'] = 'Preis für Kategorie "{$a}" darf nicht negativ sein.';
$string['agent_booking_price_not_numeric'] = 'Preis für Kategorie "{$a}" muss numerisch sein.';
...
$string['agent_booking_rules_created_rule_load_failed'] = 'Regel wurde erstellt, konnte aber nicht geladen werden.';
$string['agent_booking_rules_multiple_rules_match'] = 'Mehrere Regeln passen. Bitte ruleid angeben.';
$string['agent_booking_rules_multiple_templates_match'] = 'Mehrere Templates passen. Bitte konkreter werden oder templateid angeben.';
$string['agent_booking_rules_no_matching_rule'] = 'Keine passende Regel gefunden.';
$string['agent_booking_rules_no_rules_in_context'] = 'Keine Buchungsregeln im aktuellen Kontext gefunden.';
$string['agent_booking_rules_no_templates_available'] = 'Keine Rule-Templates verfuegbar.';
$string['agent_booking_rules_only_current_context_editable'] = 'Nur Regeln des aktuellen Buchungskontexts duerfen bearbeitet werden.';
$string['agent_booking_rules_only_predefined_templates_allowed'] = 'Nur vordefinierte Templates (negative IDs) sind erlaubt.';
$string['agent_booking_rules_only_predefined_templates_supported'] = 'Es werden nur vordefinierte Templates (negative IDs) unterstuetzt.';
$string['agent_booking_rules_provide_ruleid_or_query'] = 'Bitte ruleid oder rulequery angeben.';
$string['agent_booking_rules_provide_templateid_or_query'] = 'Bitte Template-ID oder Template-Suchbegriff angeben.';
$string['agent_booking_rules_rule_data_prepare_failed'] = 'Regeldaten konnten nicht vorbereitet werden.';
$string['agent_booking_rules_rule_not_found'] = 'Regel wurde nicht gefunden.';
$string['agent_booking_rules_ruleid_not_found_in_context'] = 'Regel-ID wurde im aktuellen Kontext nicht gefunden.';
$string['agent_booking_rules_saved_rule_not_determined'] = 'Regel wurde gespeichert, konnte aber nicht eindeutig ermittelt werden.';
$string['agent_booking_rules_template_data_prepare_failed'] = 'Template-Daten konnten nicht vorbereitet werden.';
$string['agent_booking_rules_template_load_failed'] = 'Template konnte nicht geladen werden.';
$string['agent_booking_rules_templateid_not_found'] = 'Template-ID wurde nicht gefunden.';
$string['agent_booking_rules_updated_rule_load_failed'] = 'Regel wurde aktualisiert, konnte aber nicht geladen werden.';
...
$string['agent_booking_unknown_task'] = 'Unbekannte Aufgabe "{$a}".';
$string['agent_booking_update_option_invalid_optionid'] = 'Die angegebene Options-ID {$a} gehört nicht zu dieser Buchungsinstanz.';
$string['agent_booking_update_option_invalid_optionid_question'] = 'Die Options-ID {$a} ist nicht gültig. Bitte geben Sie eine andere Options-ID oder einen Optionstitel an.';
$string['agent_booking_update_option_missing_preview_context'] = 'Der vorherige Vorschau-Kontext ist nicht mehr verfügbar.';
$string['agent_booking_update_option_missing_preview_question'] = 'Bitte geben Sie erneut an, welche Buchungsoption aktualisiert werden soll (Optionstitel oder Options-ID).';
$string['agent_booking_update_option_missing_target'] = 'Bitte geben Sie an, welche Buchungsoption aktualisiert werden soll.';
$string['agent_booking_update_option_resolution_ambiguous_question'] = 'Mehrere Buchungsoptionen passen. Welche soll ich aktualisieren? Bitte geben Sie den exakten Titel oder die Options-ID an.';
$string['agent_booking_update_option_resolution_failed_question'] = 'Ich konnte diese Buchungsoption nicht auflösen. Bitte geben Sie einen spezifischeren Optionstitel oder eine Options-ID an.';
...
$string['agent_booking_update_permission_check_failed'] = 'Die Berechtigung für dieses Update konnte im aktuellen Buchungskontext nicht geprüft werden.';
$string['agent_booking_update_permission_denied_generic'] = 'Sie dürfen ein oder mehrere angeforderte Felder nicht bearbeiten.';
$string['agent_booking_update_permission_denied_groups'] = 'Sie dürfen diese Feldgruppen in diesem Buchungskontext nicht bearbeiten: {$a}.';
...
$string['agent_booking_user_id_no_email'] = 'Benutzer-ID "{$a}" konnte nicht zu einem gültigen Benutzer mit E-Mail aufgelöst werden.';
$string['agent_booking_user_no_email'] = 'Benutzer "{$a}" gefunden, hat aber keine E-Mail-Adresse.';
$string['agent_booking_verify_field_address_failed'] = 'Feld "address" konnte nach dem Speichern nicht bestätigt werden. Angefordert: "{$a->requested}", gespeichert: "{$a->actual}".';
$string['agent_booking_verify_field_description_failed'] = 'Feld "description" konnte nach dem Speichern nicht bestätigt werden. Der angeforderte Text wurde in der gespeicherten Beschreibung nicht gefunden.';
$string['agent_booking_verify_field_headerimage_failed'] = 'Das Header-Bild konnte nach dem Speichern nicht bestätigt werden. Es wurde ein Bild angefordert, aber die Option hat kein gespeichertes Header-Bild. Versuche es erneut oder bitte den Nutzer, das Bild erneut hochzuladen.';
$string['agent_booking_verify_field_location_failed'] = 'Feld "location" konnte nach dem Speichern nicht bestätigt werden. Angefordert: "{$a->requested}", gespeichert: "{$a->actual}". Wenn local_entities aktiv ist, bedeutet dies normalerweise, dass noch keine passende Entität vorhanden ist. Legen Sie die Entität zuerst an und führen Sie booking.update_option erneut mit demselben Ort aus.';
$string['agent_booking_verify_field_maxanswers_failed'] = 'Feld "maxanswers" konnte nach dem Speichern nicht bestätigt werden. Angefordert: "{$a->requested}", gespeichert: "{$a->actual}".';
$string['agent_booking_verify_field_maxoverbooking_failed'] = 'Feld "maxoverbooking" konnte nach dem Speichern nicht bestätigt werden. Angefordert: "{$a->requested}", gespeichert: "{$a->actual}".';
...
$string['agent_booking_waitinglist_nothing_blocking'] = 'Es blockiert nichts die Warteliste: Die Option hat eine Warteliste, kein globaler Schalter ist aus und kein optionsspezifisches Gate greift. Wenn eine Reduktion trotzdem niemanden bewegt hat, prüfen Sie die genauen Platz- und Wartelistenzahlen erneut.';
$string['agent_booking_waitinglist_reason_aftercoursestart'] = 'Die Einstellung "Automatisches Nachrücken von der Warteliste nach Beginn einer Buchungsoption deaktivieren" ist aktiv und diese Option hat bereits begonnen, daher rückt niemand mehr nach.';
$string['agent_booking_waitinglist_reason_keepusersbooked'] = 'Die Einstellung "Benutzer bei Reduktion der Plätze gebucht lassen" (keepusersbookedonreducingmaxanswers) ist aktiv - beim Verringern der Plätze bleiben also alle gebucht und die Option bleibt einfach überbucht. Hinweis: Diese Einstellung ist standardmäßig AN.';
$string['agent_booking_waitinglist_reason_missingdeleteresponses'] = 'Sie speichern ohne die Berechtigung mod/booking:deleteresponses, die für eine Reduktion nötig ist, um jemanden herabzustufen oder zu entfernen. Ohne sie ändert die Reduktion stillschweigend nichts.';
$string['agent_booking_waitinglist_reason_nowaitinglist'] = 'Diese Option hat keine Warteliste (Plätze begrenzen ist aus oder die maximale Teilnehmerzahl ist 0), es gibt also niemanden zu bewegen.';
$string['agent_booking_waitinglist_reason_optionstarted'] = 'Die Option hat bereits begonnen und die Buchungsinstanz erlaubt keine Buchung nach Kursbeginn ("Buchung nach Beginn erlauben"). Das stoppt die gesamte Wartelisten-Synchronisation, inklusive jeder Herabstufung beim Verringern der Plätze.';
$string['agent_booking_waitinglist_reason_paidoption'] = 'Dies ist eine kostenpflichtige Option. Benutzer, die einen Platz gekauft haben, werden nie automatisch bewegt - sie werden weder auf eine kostenpflichtige Option nachgerückt noch beim Verringern der Plätze herabgestuft oder entfernt.';
$string['agent_booking_waitinglist_reason_turnoffglobal'] = 'Die Einstellung "Warteliste global deaktivieren" (turnoffwaitinglist) ist aktiv, daher synchronisiert die Warteliste überhaupt nicht.';
$string['agent_booking_waitinglist_reason_waitforconfirmation'] = 'Diese Option verwendet Bestätigungspflicht (waitforconfirmation), wird daher nie automatisch reduziert und Benutzer benötigen eine manuelle Bestätigung, bevor sie nachrücken.';
$string['agent_validation_bookingclosingtime_invalid'] = 'Feld "bookingclosingtime" muss ein gültiger ISO-8601-Zeitstempel oder Unix-Timestamp sein.';
$string['agent_validation_bookingopeningtime_invalid'] = 'Feld "bookingopeningtime" muss ein gültiger ISO-8601-Zeitstempel oder Unix-Timestamp sein.';
...
$string['agent_validation_bookuserstimebooked_invalid'] = 'Feld "bookuserstimebooked" muss ein gültiger ISO-8601-Zeitstempel oder Unix-Timestamp sein.';
$string['agent_validation_courseendtime_before_starttime'] = '"courseendtime" muss später als "coursestarttime" liegen.';
$string['agent_validation_courseendtime_invalid'] = 'Feld "courseendtime" muss ein gültiger ISO-8601-Zeitstempel oder Unix-Timestamp sein.';
$string['agent_validation_coursestarttime_invalid'] = 'Feld "coursestarttime" muss ein gültiger ISO-8601-Zeitstempel oder Unix-Timestamp sein.';
...
$string['agent_validation_date_end_in_past'] = 'Der angegebene Endzeitpunkt liegt in der Vergangenheit. Bitte bestätigen Sie das gewünschte Datum/die Uhrzeit.';
$string['agent_validation_date_range_label'] = 'Datumsbereich #{$a}: ';
$string['agent_validation_date_start_in_past'] = 'Der angegebene Startzeitpunkt liegt in der Vergangenheit. Bitte bestätigen Sie das gewünschte Datum/die Uhrzeit.';
...
$string['agent_validation_optiondates_invalid'] = 'Feld "optiondates" muss mindestens einen gültigen Datumsbereich enthalten.';
...
$string['agent_validation_userprofile_custom_incomplete'] = 'Für benutzerdefinierte Profilbedingung userprofilecustomfield und userprofilecustomoperator angeben.';
$string['agent_validation_userprofile_standard_incomplete'] = 'Für Standardprofilbedingung userprofilestandardfield und userprofilestandardoperator angeben.';
...
$string['ai_property_customformdeleteinfoscheckboxadmin'] = 'Benutzerdefiniertes Formular: Admin-Löschinfo-Checkbox';
...
$string['ai_property_suffix_deleteinfoscheckboxadmin'] = 'Admin-Löschinfo-Checkbox';
...
$string['ai_property_suffix_overrideconditionids'] = 'IDs für Ueberschreibungsbedingungen';
...
$string['bojwtalg'] = "JWT-Signaturalgorithmus";
$string['bojwtalg_desc'] = "HS256 signiert mit einem gemeinsamen Geheimnis (das Geheimnis ins Signierschlüssel-Feld eintragen). RS256 signiert mit einem privaten RSA-Schlüssel (den PEM-Privatschlüssel ins Signierschlüssel-Feld eintragen); der Empfänger prüft mit dem passenden öffentlichen Schlüssel, es muss also kein Geheimnis geteilt werden.";
$string['bojwtaudience'] = "JWT-Empfänger (aud)";
$string['bojwtaudience_desc'] = "Optional. Kennung des vorgesehenen Empfängers, als Standard-Claim \"aud\" gesetzt, damit der Empfänger für jemand anderen bestimmte Tokens ablehnen kann.";
$string['bojwtenable'] = "Anfrage mit einem JWT signieren";
$string['bojwtenable_desc'] = "Optional. Fügt ein signiertes JSON Web Token (RFC 7519) hinzu, das belegt, dass die Anfrage von dieser Website stammt und nicht verändert wurde. Jeder JWT-fähige Empfänger kann es prüfen. Empfohlen zusammen mit einem JSON-Body (das Token bindet den exakten Body über einen body_sha256-Claim).";
$string['bojwtheader'] = "JWT-Header-Name";
$string['bojwtheader_desc'] = "Optional, Standard \"Authorization\" (gesendet als \"Bearer <Token>\"). Anderen Header-Namen setzen, wenn der Empfänger das rohe Token woanders erwartet (z. B. \"X-Webhook-Token\").";
$string['bojwtkey'] = "JWT-Signierschlüssel";
$string['bojwtkey_desc'] = "Das gemeinsame HS256-Geheimnis oder der private RS256-PEM-Schlüssel zum Signieren des Tokens. Wird bei der Aktion gespeichert und nie an den Empfänger gesendet.";
$string['bojwtkid'] = "JWT-Schlüssel-ID (kid)";
$string['bojwtkid_desc'] = "Optional. Bei RS256 die Schlüssel-ID im Token-Header, damit ein Empfänger mit mehreren öffentlichen Schlüsseln (ein JWKS) den richtigen auswählen kann.";
$string['bojwtttl'] = "JWT-Gültigkeitsdauer (Sekunden)";
$string['bojwtttl_desc'] = "Optional, Standard 300. Wie lange das Token gültig bleibt (der \"exp\"-Claim). Kurz halten, um Replay zu begrenzen.";
...
$string['booking:skill_mod_booking_analyze_rules'] = 'KI-Skill: Buchungsregeln analysieren';
$string['booking:skill_mod_booking_book_users'] = 'KI-Skill: Nutzer:innen in eine Option einbuchen';
$string['booking:skill_mod_booking_bulk_update_options'] = 'KI-Skill: Buchungsoptionen sammelbearbeiten';
$string['booking:skill_mod_booking_configure_booking_instance'] = 'KI-Skill: Buchungsinstanz konfigurieren';
$string['booking:skill_mod_booking_create_option'] = 'KI-Skill: Buchungsoption erstellen';
$string['booking:skill_mod_booking_create_rule_from_template'] = 'KI-Skill: Buchungsregel aus Vorlage erstellen';
$string['booking:skill_mod_booking_create_selflearning_option'] = 'KI-Skill: Selbstlern-Option erstellen';
$string['booking:skill_mod_booking_create_slotbooking_option'] = 'KI-Skill: Slot-Buchungsoption erstellen';
...
$string['booking:skill_mod_booking_update_option'] = 'KI-Skill: Buchungsoption aktualisieren';
$string['booking:skill_mod_booking_update_option_trainer'] = 'KI-Skill: Trainer:in einer Buchungsoption aktualisieren';
$string['booking:skill_mod_booking_update_rule_from_template'] = 'KI-Skill: Buchungsregel aus Vorlage aktualisieren';
...
$string['bookotherusersavailability'] = 'Verfügbarkeitsbedingungen beim Buchen für andere';
$string['bookotherusersavailability:block'] = 'Buchung blockieren, wenn Verfügbarkeitsbedingungen nicht erfüllt sind';
$string['bookotherusersavailability:ignore'] = 'Verfügbarkeitsbedingungen ignorieren';
$string['bookotherusersavailability:warn'] = 'Warnung anzeigen, die bestätigt werden muss';
...
$string['bookotherusersavailabilitybookanyway'] = 'Trotzdem buchen';
...
$string['changesplaceholdertext'] = 'Fügt eine Zusammenfassung der an der Buchungsoption vorgenommenen Änderungen ein (nur verfügbar für Regeln, die auf das Ereignis "Buchungsoption aktualisiert" reagieren).';
...
$string['confirmcustomformoverwritequestion'] = 'Möchten Sie wirklich die Formularwerte der Benutzerin / des Benutzers überschreiben? Klicken Sie zur Bestätigung erneut auf "Speichern" oder brechen Sie ab.';
...
$string['customformedited'] = 'Formularwerte bearbeitet';
$string['customformeditedhistory'] = 'Der Formularwert "{$a->label}" wurde von "{$a->oldvalue}" zu "{$a->newvalue}" geändert.';
$string['customformeditordelete'] = 'Dieses Formularelement löschen';
$string['customformeditorinsert'] = 'Neues Formularelement darunter einfügen';
$string['customformeditormovedown'] = 'Formularelement nach unten verschieben';
$string['customformeditormoveup'] = 'Formularelement nach oben verschieben';
...
$string['custommessagesender'] = 'Absender';
$string['custommessagesent'] = 'Persönliche E-Mail gesendet';
$string['custommessagessentto'] = 'Persönliche E-Mails wurden an folgende Personen gesendet: {$a}';
...
$string['editcustomformvalues'] = 'Formularwerte bearbeiten';
...
$string['entitytreefilter'] = 'Mehrstufiger Ortsfilter';
$string['entitytreefilter_desc'] = 'Den Ortsfilter als mehrstufigen Entity-Baum anzeigen (Ort → Gebäude → Stockwerk → Raum …) statt als flache Liste. Bei Auswahl eines Knotens werden alle untergeordneten Orte mit einbezogen. Erfordert das Plugin local_entities. Wenn deaktiviert, wird der einfache Textfilter für Orte verwendet (unverändert).';
$string['entitytreefiltershowlocationhovercard'] = '⤷ Hover-Karte für mehrstufige Standorte anzeigen';
$string['entitytreefiltershowlocationhovercard_desc'] = 'Bei Standorten mit drei oder mehr Hierarchie-Ebenen alle übergeordneten Ebenen beim Überfahren bzw. Fokussieren in einer kleinen Karte anzeigen. Wenn deaktiviert, wird nur "direkter Parent (Entity)" ohne Hover-Karte angezeigt.';
$string['entitytreefiltershowlocationimages'] = '⤷ Bilder in der Standort-Hover-Karte anzeigen';
$string['entitytreefiltershowlocationimages_desc'] = 'Bei Standorten mit drei oder mehr Hierarchie-Ebenen werden die übergeordneten Ebenen beim Überfahren bzw. Fokussieren in einer kleinen Karte angezeigt. Wenn aktiviert, werden die Bilder der Entities als kleine Vorschaubilder in dieser Karte dargestellt.';
$string['entitytreefiltertoplevelonly'] = '⤷ Ortsfilter: nur in oberster Ebene filtern';
$string['entitytreefiltertoplevelonly_desc'] = 'Im Ortsfilter nur die erste (oberste) Ebene des Entity-Baums anbieten. Die Auswahl eines Eintrags filtert alle Buchungsoptionen des gesamten Zweigs; die Unterebenen (z.&nbsp;B. einzelne Räume) werden nicht als eigene Filteroptionen angeboten. Wirkt nur zusammen mit dem mehrstufigen Ortsfilter.';
...
$string['error:answernotinthisoption'] = 'Die Buchungsantwort (ID: {$a->answerid}) gehört nicht zur angegebenen Buchungsoption (ID: {$a->optionid}).';
...
$string['error:selectonlyonerow'] = 'Bitte wählen Sie genau eine Zeile für diese Aktion aus.';
...
$string['ersaverelationsforoptiondates'] = 'Entität auch für jeden Termin speichern';
...
$string['facilityinfo'] = 'Sportstätteninfos';
...
$string['forcessubscribe'] = 'Für diese Aktivität wurde die Abo-Pflicht aktiviert. Alle infrage kommenden Nutzer/innen sind automatisch angemeldet und können sich nicht selbst abmelden.';
...
$string['fulltextsearchcolumns'] = 'Spalten, die zur Volltextsuche hinzugefügt werden';
$string['fulltextsearchcolumns_help'] = 'Wählen Sie zusätzliche Spalten von Buchungsoptionen und benutzerdefinierte Buchungsfelder aus, die von der Volltextsuche der Buchungsoptionen-Tabelle durchsucht werden.';
...
$string['loadtemplate'] = 'Fehler beim Laden der Optionsdaten aus der ausgewählten Vorlage.';
$string['location'] = 'Ort';
...
$string['manageresponsespagefields'] = 'Buchungen verwalten & Buchungstracker';
...
$string['nocreditsfielddefined'] = 'Es wurde kein Nutzerprofilfeld für Credits konfiguriert. Bitte kontaktieren Sie die Administration.';
...
$string['noitems'] = 'Es gibt keine zusätzlichen Artikel zu buchen.';
...
$string['norighttoaccess'] = 'Sie sind nicht berechtigt, darauf zuzugreifen.';
...
$string['notenoughcredits'] = 'Sie haben nicht genügend Credits.';
...
$string['pdfahint'] = 'Ist „PDF/A-2b-konforme PDFs erzeugen“ in den Einstellungen des Plugins Wunderbyte Table (local_wunderbyte_table) aktiviert, wird diese Vorlage als PDF/A-2b gerendert: Verwenden Sie die Schriften FreeSans / FreeSerif / FreeMono (Helvetica, Arial → FreeSans; Times → FreeSerif; Courier → FreeMono) und RGB-Bilder (PNG oder JPEG, kein CMYK).';
$string['pdflandscape'] = 'Querformat';
$string['pdforientation'] = 'Ausrichtung';
$string['pdfportrait'] = 'Hochformat';
$string['pdftitleinstance'] = 'Name der Buchungsinstanz';
$string['pdftitleinstanceoption'] = 'Name der Buchungsinstanz: Name der Buchungsoption';
$string['pdftitleoption'] = 'Name der Buchungsoption';
...
$string['privacy:metadata:bookingslotmoves'] = 'Ausstehende und abgeschlossene Umbuchungen der gebuchten Slots einer Person inklusive Preisdifferenz';
$string['privacy:metadata:bookingslotmoves:baid'] = 'ID der Buchungsantwort, die umgebucht wird';
$string['privacy:metadata:bookingslotmoves:expiry'] = 'Ablaufzeitpunkt einer ausstehenden Umbuchung';
$string['privacy:metadata:bookingslotmoves:identifier'] = 'Warenkorb-Checkout-Identifier nach Abschluss der Umbuchung';
$string['privacy:metadata:bookingslotmoves:newslots'] = 'Die Ziel-Slots der Umbuchung';
$string['privacy:metadata:bookingslotmoves:oldslots'] = 'Die aufgegebenen Slots der Umbuchung';
$string['privacy:metadata:bookingslotmoves:optionid'] = 'ID der Buchungsoption, zu der die Umbuchung gehört';
$string['privacy:metadata:bookingslotmoves:pricedelta'] = 'Preisdifferenz (neu minus alt), festgeschrieben bei Erstellung';
$string['privacy:metadata:bookingslotmoves:status'] = 'Status der Umbuchung (ausstehend, abgeschlossen oder storniert)';
$string['privacy:metadata:bookingslotmoves:timecreated'] = 'Zeitpunkt der Erstellung der Umbuchung';
$string['privacy:metadata:bookingslotmoves:timemodified'] = 'Zeitpunkt der letzten Änderung der Umbuchung';
$string['privacy:metadata:bookingslotmoves:userid'] = 'Person, deren gebuchte Slots umgebucht werden';
$string['privacy:metadata:bookingslotstudentteacher'] = 'Einer Person zugewiesene:r Trainer:in für eine Slot-Buchungsoption';
$string['privacy:metadata:bookingslotstudentteacher:optionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookingslotstudentteacher:teacherid'] = 'Nutzer-ID der zugewiesenen Trainer:in';
$string['privacy:metadata:bookingslotstudentteacher:timecreated'] = 'Zeitpunkt der Erstellung der Zuweisung';
$string['privacy:metadata:bookingslotstudentteacher:timemodified'] = 'Zeitpunkt der letzten Änderung der Zuweisung';
$string['privacy:metadata:bookingslotstudentteacher:userid'] = 'Person (Teilnehmer:in), der die Trainer:in zugewiesen ist';
$string['privacy:metadata:bookingsyncattempts'] = 'Protokoll einzelner Einschreibungs-Synchronisationsversuche (Einschreibung/Abmeldung) pro Person zu Diagnosezwecken';
$string['privacy:metadata:bookingsyncattempts:action'] = 'Ob der Versuch eine Einschreibung oder eine Abmeldung war';
$string['privacy:metadata:bookingsyncattempts:bookingoptionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookingsyncattempts:reasoncode'] = 'Ergebniscode des Versuchs';
$string['privacy:metadata:bookingsyncattempts:reasonmessage'] = 'Lesbare Ergebnismeldung des Versuchs';
$string['privacy:metadata:bookingsyncattempts:syncruleid'] = 'ID der Sync-Regel, die den Versuch ausgelöst hat';
$string['privacy:metadata:bookingsyncattempts:timecreated'] = 'Zeitpunkt des Versuchs';
$string['privacy:metadata:bookingsyncattempts:userid'] = 'Person, für die der Einschreibungs-/Abmeldeversuch durchgeführt wurde';
$string['privacy:metadata:bookingteacherunavailability'] = 'Abwesenheitszeiträume von Trainer:innen für die Slot-Buchung';
$string['privacy:metadata:bookingteacherunavailability:optionid'] = 'ID der Buchungsoption';
$string['privacy:metadata:bookingteacherunavailability:reason'] = 'Grund der Abwesenheit';
$string['privacy:metadata:bookingteacherunavailability:teacherid'] = 'Nutzer-ID der abwesenden Trainer:in';
$string['privacy:metadata:bookingteacherunavailability:timecreated'] = 'Zeitpunkt der Erstellung des Eintrags';
$string['privacy:metadata:bookingteacherunavailability:unavailablefrom'] = 'Beginn des Abwesenheitszeitraums';
$string['privacy:metadata:bookingteacherunavailability:unavailableuntil'] = 'Ende des Abwesenheitszeitraums';
...
$string['savingoptiondatewentwrong'] = 'Beim Speichern der Termine dieser Buchungsoption ist ein Fehler aufgetreten.';
...
$string['sendcustommsg'] = 'Persönliche E-Mail senden';
...
$string['sendmessagetoresponsiblecontacts'] = 'E-Mail an Kontaktperson(en)';
...
$string['shortcode:slotbookingtypemismatch'] = 'Diese Buchungsoptionen verwenden unterschiedliche Slot-Typen (z. B. fest vs. benutzerdefiniert) und können nicht gemeinsam in einem Kalender angezeigt werden. Bitte kombinieren Sie nur Buchungsoptionen mit demselben Slot-Typ.';
...
$string['signinsheetdefaults_desc'] = 'Diese Einstellungen werden für den Download der Unterschriftenliste verwendet, sofern sie nicht in einer Buchungsinstanz überschrieben oder in einer Buchungsoption gespeichert wurden.';
...
$string['signinsheetusepluginconfig'] = 'Einstellungen für die Unterschriftenliste aus der <a href="{$a}" target="_blank">Plugin-Konfiguration</a> verwenden';
...
$string['slot_buffer_combination_mode'] = 'Umgang mit angrenzenden Pufferzeiten';
$string['slot_buffer_combination_mode_help'] = 'Wenn die Nachbereitungszeit eines Slots auf die Vorbereitungszeit des nächsten trifft: "Puffer dürfen sich überschneiden" verlangt nur den Abstand des längeren der beiden Puffer; "Puffer werden summiert" verlangt die volle Länge beider Puffer nacheinander.';
$string['slot_buffer_combination_mode_overlap'] = 'Puffer dürfen sich überschneiden';
$string['slot_buffer_combination_mode_summed'] = 'Puffer werden summiert';
$string['slot_buffer_cooldown_minutes'] = 'Nachbereitungszeit nach Slot (Minuten)';
$string['slot_buffer_cooldown_minutes_help'] = 'Sperrt diese Anzahl an Minuten nach dem Ende eines Slots, z.B. für Reinigung oder Nachbereitung. 0 deaktiviert die Nachbereitungszeit.';
$string['slot_buffer_warmup_minutes'] = 'Vorbereitungszeit vor Slot (Minuten)';
$string['slot_buffer_warmup_minutes_help'] = 'Sperrt diese Anzahl an Minuten vor dem Start eines Slots, z.B. für Vorbereitung. 0 deaktiviert die Vorbereitungszeit.';
...
$string['slot_custom_duration_step_minutes'] = 'Schrittweite der Slot-Dauer (Minuten)';
...
$string['slot_error_max_slots_reached'] = 'Sie haben die maximale Anzahl an Slots, die Sie für diese Buchungsoption buchen können, bereits erreicht.';
...
$string['slot_error_selection_overlap'] = 'Die gewählten Slots überschneiden sich zeitlich. Bitte wählen Sie nicht überlappende Slots.';
...
$string['slot_max_slots_per_user_help'] = 'Die Gesamtzahl an separaten Slots, die eine Person für diese Buchungsoption gleichzeitig halten kann (z. B. mehrere Slots als einzelne, zeitlich unabhängige Käufe). Diese Einstellung ist unabhängig von der Instanz-Einstellung "Wiederbuchung erlauben": Diese steuert nur, ob nach Ende der Buchung bzw. nach einer Wartezeit erneut gebucht werden darf, begrenzt aber nicht die Anzahl gehaltener Slots. Beide Einstellungen können kombiniert werden, ersetzen sich aber gegenseitig nicht.';
...
$string['slotbooking_invert_selection'] = 'Auswahl umkehren';
$string['slotbooking_no_custom_day_available'] = 'Für diese Buchungsoption ist an diesem Tag kein Termin verfügbar.';
$string['slotbooking_prepage_description'] = 'Bitte wählen Sie einen verfügbaren Slot aus, bevor Sie mit der Buchung fortfahren.';
$string['slotbooking_sidebar_title'] = 'Buchungsoptionen';
$string['slotbooking_switched_option'] = 'Ihre vorherige Slot-Auswahl wurde zurückgesetzt, da Sie nur Slots einer einzigen Buchungsoption gleichzeitig buchen können.';
...
$string['subscribealreadybooked'] = '(ist bereits gebucht)';
...
$string['usenonnativemailer_desc'] = 'Wenn aktiviert, werden E-Mails mit Kalendereinladungen über einen nicht nativen Mailer anstelle des integrierten Moodle-Mailers gesendet, um sicherzustellen, dass die Empfänger die Schaltflächen „Annehmen/Ablehnen“ sehen. Das gilt nur für Buchungsoptionen mit einem einzigen Termin: Eine Besprechungsanfrage (mit Annehmen/Ablehnen) kann nur einen Termin enthalten, Optionen mit mehreren Terminen werden daher immer als normale E-Mail mit der iCal-Datei aller Termine versendet.';
...
$string['wrongfile'] = 'Falsche Datei. Bitte wählen Sie eine gültige Datei zum Importieren aus.';
...
$string['wrongpagenumberforprebookingpage'] = 'Die Seitenzahl für die Vorbuchungsseite ist ungültig.';
$string['wrongstructureofsearchparams'] = 'Die Struktur der Suchparameter ist ungültig.';
